...
public class PlayerTriggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TD_00242449 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024finalDMG_00242450;

			internal int _0024poo_00242451;

			internal Item _0024item_00242452;

			internal GameObject _0024d_00242453;

			internal int _0024se_00242454;

			internal GameObject _0024n2_00242455;

			internal int _0024DMG_00242456;

			internal PlayerTriggerScript _0024self__00242457;

			public _0024(int DMG, PlayerTriggerScript self_)
			{
				_0024DMG_00242456 = DMG;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024finalDMG_00242450 = _0024DMG_00242456 - ShieldDEF;
					if (_0024finalDMG_00242450 < 1)
					{
						_0024finalDMG_00242450 = 1;
					}
					if (MenuScript.multiplayer > 0 && ((Component)_0024self__00242457).networkView.isMine && canTakeDamage && !GameScript.win)
					{
						if (MenuScript.pHat == 13)
						{
							_0024poo_00242451 = Random.Range(0, 5);
							if (_0024poo_00242451 == 0)
							{
								_0024item_00242452 = new Item(Random.Range(9, 12), 1, new int[4], 0f, null);
								_0024d_00242453 = (GameObject)Network.Instantiate(Resources.Load("item"), ((Component)_0024self__00242457).transform.position, Quaternion.identity, 1);
								_0024d_00242453.networkView.RPC("SetID", (RPCMode)6, new object[1] { _0024item_00242452.id });
								_0024d_00242453.networkView.RPC("SetD", (RPCMode)6, new object[1] { _0024item_00242452.d });
								_0024d_00242453.networkView.RPC("SetE", (RPCMode)6, new object[1] { _0024item_00242452.e });
								_0024d_00242453.networkView.RPC("SetQ", (RPCMode)6, new object[1] { _0024item_00242452.q });
							}
						}
						else if (MenuScript.pHat == 14)
						{
							_0024se_00242454 = Random.Range(0, 10);
							if (_0024se_00242454 == 0)
							{
								Network.Instantiate(Resources.Load("e/broodmother"), new Vector3(((Component)_0024self__00242457).transform.position.x, ((Component)_0024self__00242457).transform.position.y + 50f, 0f), Quaternion.identity, 0);
							}
						}
						((Component)_0024self__00242457).audio.PlayOneShot(_0024self__00242457.ow);
						canTakeDamage = false;
						_0024n2_00242455 = (GameObject)Network.Instantiate((Object)(GameObject)Resources.Load("TD1", typeof(GameObject)), ((Component)_0024self__00242457).transform.position, Quaternion.identity, 0);
						_0024n2_00242455.networkView.RPC("SDN", (RPCMode)2, new object[1] { _0024finalDMG_00242450 });
						_0024self__00242457.gameScript.TD(_0024finalDMG_00242450);
						_0024self__00242457.gameScript.LoadHearts();
						GameScript.canTakeDamage = false;
						((MonoBehaviour)_0024self__00242457).StartCoroutine_Auto(_0024self__00242457.GetHit());
						if (GameScript.HP >= 1)
						{
						...
						GameScript.HP = 0;
						_0024self__00242457.player.SendMessage("Die");
						if (MenuScript.deathA == 1)
						{
							_0024self__00242457.player.SendMessage("DeathAnim");
						}
						isDead = true;
						_0024self__00242457.@base.animation.Play("dead");
					}
					goto IL_0366;
				case 2:
					canTakeDamage = true;
		...
		internal int _0024DMG_00242458;

		internal PlayerTriggerScript _0024self__00242459;

		public _0024TD_00242449(int DMG, PlayerTriggerScript self_)
		{
			_0024DMG_00242458 = DMG;
			_0024self__00242459 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024DMG_00242458, _0024self__00242459);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GetHit_00242460 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024905_00242461;

			internal Vector3 _0024_0024906_00242462;

			internal int _0024_0024907_00242463;

			internal Vector3 _0024_0024908_00242464;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					((Component)_0024self__00242465).animation.Play();
					_0024self__00242465.gameScript.heartsObj.animation.Play();
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
					break;
				case 2:
				{
					((Component)_0024self__00242465).animation.Stop();
					_0024self__00242465.gameScript.heartsObj.animation.Stop();
					GameScript.canTakeDamage = true;
					int num = (_0024_0024905_00242461 = 0);
					Vector3 val = (_0024_0024906_00242462 = ((Component)_0024self__00242465).transform.localPosition);
					float num2 = (_0024_0024906_00242462.z = _0024_0024905_00242461);
					Vector3 val3 = (((Component)_0024self__00242465).transform.localPosition = _0024_0024906_00242462);
					int num3 = (_0024_0024907_00242463 = 20);
					Vector3 val4 = (_0024_0024908_00242464 = _0024self__00242465.gameScript.heartsObj.transform.localPosition);
					float num4 = (_0024_0024908_00242464.z = _0024_0024907_00242463);
					Vector3 val6 = (_0024self__00242465.gameScript.heartsObj.transform.localPosition = _0024_0024908_00242464);
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				}
				case 1:
		...
		internal PlayerTriggerScript _0024self__00242466;

		public _0024GetHit_00242460(PlayerTriggerScript self_)
		{
	...
	{
		return new _0024TD_00242449(DMG, this).GetEnumerator();
	}

	public override IEnumerator GetHit()
	{
		return new _0024GetHit_00242460(this).GetEnumerator();
	}
