...
public class ArrowScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241301 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal ArrowScript _0024self__00241302;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241302.t = ((Component)_0024self__00241302).transform;
					if (_0024self__00241302.isEnemy)
					{
						_0024self__00241302.speed = 23f;
					}
					if (_0024self__00241302.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241302).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241302).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241302).gameObject);
					}
		...
		internal ArrowScript _0024self__00241303;

		public _0024Start_00241301(ArrowScript self_)
		{
	...
	{
		return new _0024Start_00241301(this).GetEnumerator();
	}
	...
	public override void OnTriggerEnter(Collider c)
	{
		...
		else if (((Component)c).gameObject.layer == 11 && !initialized && !isEnemy)
		{
			initialized = true;
			cantMove = true;
