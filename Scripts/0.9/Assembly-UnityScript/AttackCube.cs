...
public class AttackCube : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241304 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal AttackCube _0024self__00241305;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!Object.op_Implicit((Object)(object)_0024self__00241305.gameScript))
					{
						_0024self__00241305.gameScript = (GameScript)(object)GameObject.Find("GameManager").GetComponent("GameScript");
					}
		...
		internal AttackCube _0024self__00241306;

		public _0024Start_00241304(AttackCube self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Anim_00241307 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal int _0024_0024423_00241309;

			internal Vector2 _0024_0024424_00241310;

			internal float _0024_0024425_00241311;

			internal Vector2 _0024_0024426_00241312;

			internal int _0024_0024427_00241313;

			internal Vector2 _0024_0024428_00241314;

			internal AttackCube _0024self__00241315;
			...
			public override bool MoveNext()
			{
				...
				default:
				{
					...
					int num = (_0024_0024423_00241309 = 0);
					Vector2 val = (_0024_0024424_00241310 = _0024self__00241315.atkAnim.renderer.material.mainTextureOffset);
					float num2 = (_0024_0024424_00241310.x = _0024_0024423_00241309);
					Vector2 val3 = (_0024self__00241315.atkAnim.renderer.material.mainTextureOffset = _0024_0024424_00241310);
					_0024i_00241308 = 0;
					goto IL_0154;
				}
				case 2:
				...
				case 1:
					...
					IL_0154:
					if (_0024i_00241308 < 3)
					{
						float num3 = (_0024_0024425_00241311 = _0024self__00241315.atkAnim.renderer.material.mainTextureOffset.x + 0.25f);
						Vector2 val4 = (_0024_0024426_00241312 = _0024self__00241315.atkAnim.renderer.material.mainTextureOffset);
						float num4 = (_0024_0024426_00241312.x = _0024_0024425_00241311);
						Vector2 val6 = (_0024self__00241315.atkAnim.renderer.material.mainTextureOffset = _0024_0024426_00241312);
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.05f)) ? 1 : 0);
						break;
					}
					num5 = (_0024_0024427_00241313 = 0);
					val7 = (_0024_0024428_00241314 = _0024self__00241315.atkAnim.renderer.material.mainTextureOffset);
					num6 = (_0024_0024428_00241314.x = _0024_0024427_00241313);
					val9 = (_0024self__00241315.atkAnim.renderer.material.mainTextureOffset = _0024_0024428_00241314);
		...
		internal AttackCube _0024self__00241316;

		public _0024Anim_00241307(AttackCube self_)
		{
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241316);
		}
	}
	...
	{
		return new _0024Start_00241304(this).GetEnumerator();
	}
	...
	{
		return new _0024Anim_00241307(this).GetEnumerator();
	}
