...
public class CritScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241420 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal CritScript _0024self__00241421;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					_0024self__00241421.stop = true;
					if (MenuScript.multiplayer > 0)
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241421).gameObject, 0.5f);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241421).gameObject, 0.5f);
		...
		internal CritScript _0024self__00241422;

		public _0024Start_00241420(CritScript self_)
		{
