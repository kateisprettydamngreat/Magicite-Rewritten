...
public class PlayerTriggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TD_00242402 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024finalDMG_00242403;

			internal int _0024poo_00242404;

			internal Item _0024item_00242405;

			internal GameObject _0024d_00242406;

			internal int _0024se_00242407;

			internal GameObject _0024n2_00242408;

			internal int _0024DMG_00242409;

			internal PlayerTriggerScript _0024self__00242410;

			public _0024(int DMG, PlayerTriggerScript self_)
			{
				_0024DMG_00242409 = DMG;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024finalDMG_00242403 = _0024DMG_00242409 - ShieldDEF;
					if (_0024finalDMG_00242403 < 1)
					{
						_0024finalDMG_00242403 = 1;
					}
					if (MenuScript.multiplayer > 0 && ((Component)_0024self__00242410).networkView.isMine && canTakeDamage && !GameScript.win)
					{
						if (MenuScript.pHat == 13)
						{
							_0024poo_00242404 = Random.Range(0, 5);
							if (_0024poo_00242404 == 0)
							{
								_0024item_00242405 = new Item(Random.Range(9, 12), 1, new int[4], 0f, null);
								_0024d_00242406 = (GameObject)Network.Instantiate(Resources.Load("item"), ((Component)_0024self__00242410).transform.position, Quaternion.identity, 1);
								_0024d_00242406.networkView.RPC("SetID", (RPCMode)6, new object[1] { _0024item_00242405.id });
								_0024d_00242406.networkView.RPC("SetD", (RPCMode)6, new object[1] { _0024item_00242405.d });
								_0024d_00242406.networkView.RPC("SetE", (RPCMode)6, new object[1] { _0024item_00242405.e });
								_0024d_00242406.networkView.RPC("SetQ", (RPCMode)6, new object[1] { _0024item_00242405.q });
							}
						}
						else if (MenuScript.pHat == 14)
						{
							_0024se_00242407 = Random.Range(0, 10);
							if (_0024se_00242407 == 0)
							{
								Network.Instantiate(Resources.Load("e/broodmother"), new Vector3(((Component)_0024self__00242410).transform.position.x, ((Component)_0024self__00242410).transform.position.y + 50f, 0f), Quaternion.identity, 0);
							}
						}
						((Component)_0024self__00242410).audio.PlayOneShot(_0024self__00242410.ow);
						canTakeDamage = false;
						_0024n2_00242408 = (GameObject)Network.Instantiate((Object)(GameObject)Resources.Load("TD1", typeof(GameObject)), ((Component)_0024self__00242410).transform.position, Quaternion.identity, 0);
						_0024n2_00242408.networkView.RPC("SDN", (RPCMode)2, new object[1] { _0024finalDMG_00242403 });
						_0024self__00242410.gameScript.TD(_0024finalDMG_00242403);
						_0024self__00242410.gameScript.LoadHearts();
						GameScript.canTakeDamage = false;
						((MonoBehaviour)_0024self__00242410).StartCoroutine_Auto(_0024self__00242410.GetHit());
						if (GameScript.HP >= 1)
						{
						...
						GameScript.HP = 0;
						_0024self__00242410.player.SendMessage("Die");
						isDead = true;
						_0024self__00242410.@base.animation.Play("dead");
					}
					goto IL_0346;
				case 2:
					canTakeDamage = true;
		...
		internal int _0024DMG_00242411;

		internal PlayerTriggerScript _0024self__00242412;

		public _0024TD_00242402(int DMG, PlayerTriggerScript self_)
		{
			_0024DMG_00242411 = DMG;
			_0024self__00242412 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024DMG_00242411, _0024self__00242412);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GetHit_00242413 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024897_00242414;

			internal Vector3 _0024_0024898_00242415;

			internal int _0024_0024899_00242416;

			internal Vector3 _0024_0024900_00242417;

			internal PlayerTriggerScript _0024self__00242418;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					((Component)_0024self__00242418).animation.Play();
					_0024self__00242418.gameScript.heartsObj.animation.Play();
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
					break;
				case 2:
				{
					((Component)_0024self__00242418).animation.Stop();
					_0024self__00242418.gameScript.heartsObj.animation.Stop();
					GameScript.canTakeDamage = true;
					int num = (_0024_0024897_00242414 = 0);
					Vector3 val = (_0024_0024898_00242415 = ((Component)_0024self__00242418).transform.localPosition);
					float num2 = (_0024_0024898_00242415.z = _0024_0024897_00242414);
					Vector3 val3 = (((Component)_0024self__00242418).transform.localPosition = _0024_0024898_00242415);
					int num3 = (_0024_0024899_00242416 = 20);
					Vector3 val4 = (_0024_0024900_00242417 = _0024self__00242418.gameScript.heartsObj.transform.localPosition);
					float num4 = (_0024_0024900_00242417.z = _0024_0024899_00242416);
					Vector3 val6 = (_0024self__00242418.gameScript.heartsObj.transform.localPosition = _0024_0024900_00242417);
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				}
				case 1:
		...
		internal PlayerTriggerScript _0024self__00242419;

		public _0024GetHit_00242413(PlayerTriggerScript self_)
		{
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00242419);
		}
	}
	...
	{
		return new _0024TD_00242402(DMG, this).GetEnumerator();
	}

	public override IEnumerator GetHit()
	{
		return new _0024GetHit_00242413(this).GetEnumerator();
	}
