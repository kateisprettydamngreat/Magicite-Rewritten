...
public class RockScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Die_00242426 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal RockScript _0024self__00242427;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						Network.Destroy(((Component)_0024self__00242427).networkView.viewID);
					}
		...
		internal RockScript _0024self__00242428;

		public _0024Die_00242426(RockScript self_)
		{
	...
	{
		return new _0024Die_00242426(this).GetEnumerator();
	}
