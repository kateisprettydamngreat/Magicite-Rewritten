...
public class ItemScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241946 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal int _0024_0024691_00241947;

			internal Vector3 _0024_0024692_00241948;

			internal ItemScript _0024self__00241949;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241949.dropped)
					{
						_0024self__00241949.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024691_00241947 = Random.Range(5, 9));
						Vector3 val = (_0024_0024692_00241948 = _0024self__00241949.r.velocity);
						float num2 = (_0024_0024692_00241948.y = _0024_0024691_00241947);
						Vector3 val3 = (_0024self__00241949.r.velocity = _0024_0024692_00241948);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241949.@base.collider.enabled = true;
					_0024self__00241949.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(15f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241949).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241949).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241949).gameObject);
					}
		...
		internal ItemScript _0024self__00241950;

		public _0024Start_00241946(ItemScript self_)
		{
