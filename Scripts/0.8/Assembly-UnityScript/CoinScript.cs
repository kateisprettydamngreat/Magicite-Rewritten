...
public class CoinScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241384 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal CoinScript _0024self__00241385;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					_0024self__00241385.core.animation.Play();
					_0024self__00241385.@base.collider.enabled = true;
					_0024self__00241385.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(10f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241385).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241385).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241385).gameObject);
					}
		...
		internal CoinScript _0024self__00241386;

		public _0024Start_00241384(CoinScript self_)
		{
	...
	{
		return new _0024Start_00241384(this).GetEnumerator();
	}
