...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242516 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242517;

			internal ScourgeWall _0024self__00242518;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242518).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242517 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242518.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242519;

		public _0024ShootStuff_00242516(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242520 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242521;

			internal ScourgeWall _0024self__00242522;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242521 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242522.hp -= _0024dmg_00242521;
		...
		internal int _0024dmg_00242523;

		internal ScourgeWall _0024self__00242524;

		public _0024TDN_00242520(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242523 = dmg;
			_0024self__00242524 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242523, _0024self__00242524);
		}
	}
	...
	{
		return new _0024ShootStuff_00242516(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242520(dmg, this).GetEnumerator();
	}
