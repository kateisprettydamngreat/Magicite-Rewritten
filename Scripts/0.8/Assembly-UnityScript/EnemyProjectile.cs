...
public class EnemyProjectile : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241419 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal EnemyProjectile _0024self__00241420;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241420.t = ((Component)_0024self__00241420).transform;
					...
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241420).gameObject, 5f);
					}
					goto IL_0081;
				case 2:
					Network.Destroy(((Component)_0024self__00241420).networkView.viewID);
					goto IL_0081;
				case 1:
					{
						result = 0;
		...
		internal EnemyProjectile _0024self__00241421;

		public _0024Start_00241419(EnemyProjectile self_)
		{
	...
	{
		return new _0024Start_00241419(this).GetEnumerator();
	}
