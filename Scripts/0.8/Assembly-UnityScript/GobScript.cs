...
public class GobScript : EnemyScript
{
	...
	internal sealed class _0024ChargeRight_00242593 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal int _0024_0024965_00242594;

			internal Vector3 _0024_0024966_00242595;

			internal GobScript _0024self__00242596;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242596.charging && MenuScript.multiplayer == 1)
					{
						int num = (_0024_0024965_00242594 = 15);
						Vector3 val = (_0024_0024966_00242595 = _0024self__00242596.r.velocity);
						float num2 = (_0024_0024966_00242595.y = _0024_0024965_00242594);
						Vector3 val3 = (_0024self__00242596.r.velocity = _0024_0024966_00242595);
						_0024self__00242596.charging = true;
						((Component)_0024self__00242596).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
						((Component)_0024self__00242596).networkView.RPC("ATK", (RPCMode)2, new object[0]);
					...
					goto IL_011f;
				case 2:
					((Component)_0024self__00242596).networkView.RPC("IDLE", (RPCMode)2, new object[0]);
		...
		internal GobScript _0024self__00242597;

		public _0024ChargeRight_00242593(GobScript self_)
		{
	...
	internal sealed class _0024ChargeLeft_00242598 : GenericGenerator<WaitForSeconds>
	{
		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024967_00242599;

			internal Vector3 _0024_0024968_00242600;

			internal GobScript _0024self__00242601;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242601.charging && MenuScript.multiplayer == 1)
					{
						int num = (_0024_0024967_00242599 = 15);
						Vector3 val = (_0024_0024968_00242600 = _0024self__00242601.r.velocity);
						float num2 = (_0024_0024968_00242600.y = _0024_0024967_00242599);
						Vector3 val3 = (_0024self__00242601.r.velocity = _0024_0024968_00242600);
						_0024self__00242601.charging = true;
						((Component)_0024self__00242601).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
						((Component)_0024self__00242601).networkView.RPC("ATK", (RPCMode)2, new object[0]);
					...
					goto IL_0120;
				case 2:
					((Component)_0024self__00242601).networkView.RPC("IDLE", (RPCMode)2, new object[0]);
		...
		internal GobScript _0024self__00242602;

		public _0024ChargeLeft_00242598(GobScript self_)
		{
