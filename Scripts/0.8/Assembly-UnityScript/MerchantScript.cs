...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241179 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			internal MerchantScript _0024self__00241180;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241180).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241180.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241180).StartCoroutine_Auto(_0024self__00241180.Talkn(_0024self__00241180.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		internal MerchantScript _0024self__00241181;

		public _0024Start_00241179(MerchantScript self_)
		{
		...
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241181);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241182 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241183;

			internal MerchantScript _0024self__00241184;

			public _0024(string s, MerchantScript self_)
			{
				_0024s_00241183 = s;
				_0024self__00241184 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241184.@base.animation.Play("t");
					_0024self__00241184.txtTalk.text = _0024s_00241183;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241184.txtTalk.text = string.Empty;
					_0024self__00241184.@base.animation.Play("i");
		...
		internal string _0024s_00241185;

		internal MerchantScript _0024self__00241186;

		public _0024Talkn_00241182(string s, MerchantScript self_)
		{
			_0024s_00241185 = s;
			_0024self__00241186 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241185, _0024self__00241186);
		}
	}
	...
	{
		return new _0024Talkn_00241182(s, this).GetEnumerator();
	}
