...
public class LightBlast : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241989 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal LightBlast _0024self__00241990;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241990.t = ((Component)_0024self__00241990).transform;
					if (_0024self__00241990.isRight)
					{
					}
					((Component)_0024self__00241990).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241990).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241990).gameObject);
					}
		...
		internal LightBlast _0024self__00241991;

		public _0024Start_00241989(LightBlast self_)
		{
