...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242244 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal ScourgeWall _0024self__00242246;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242246).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242245 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242246.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242247;

		public _0024ShootStuff_00242244(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242248 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242249;

			internal ScourgeWall _0024self__00242250;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242249 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242250.hp -= _0024dmg_00242249;
		...
		internal int _0024dmg_00242251;

		internal ScourgeWall _0024self__00242252;

		public _0024TDN_00242248(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242251 = dmg;
			_0024self__00242252 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242251, _0024self__00242252);
		}
	}
	...
	{
		return new _0024ShootStuff_00242244(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242248(dmg, this).GetEnumerator();
	}
