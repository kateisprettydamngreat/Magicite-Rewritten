...
public class TitanTrig : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Trig_00242492 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal TitanTrig _0024self__00242493;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					((Component)_0024self__00242493).collider.enabled = false;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(0.2f)) ? 1 : 0);
					break;
				case 3:
					((Component)_0024self__00242493).collider.enabled = true;
					goto default;
				case 1:
					result = 0;
					break;
		...
		internal TitanTrig _0024self__00242494;

		public _0024Trig_00242492(TitanTrig self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00242494);
		}
	}
	...
	{
		return new _0024Trig_00242492(this).GetEnumerator();
	}
