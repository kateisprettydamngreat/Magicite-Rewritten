...
public class PlayerTriggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TD_00242136 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024finalDMG_00242137;

			internal int _0024poo_00242138;

			internal Item _0024item_00242139;

			internal GameObject _0024d_00242140;

			internal int _0024se_00242141;

			internal GameObject _0024n2_00242142;

			internal int _0024DMG_00242143;

			internal PlayerTriggerScript _0024self__00242144;

			public _0024(int DMG, PlayerTriggerScript self_)
			{
				_0024DMG_00242143 = DMG;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024finalDMG_00242137 = _0024DMG_00242143 - ShieldDEF;
					if (_0024finalDMG_00242137 < 1)
					{
						_0024finalDMG_00242137 = 1;
					}
					if (MenuScript.multiplayer > 0 && ((Component)_0024self__00242144).networkView.isMine && canTakeDamage && !GameScript.win)
					{
						if (MenuScript.pHat == 13)
						{
							_0024poo_00242138 = Random.Range(0, 5);
							if (_0024poo_00242138 == 0)
							{
								_0024item_00242139 = new Item(Random.Range(9, 12), 1, new int[4], 0f, null);
								_0024d_00242140 = (GameObject)Network.Instantiate(Resources.Load("item"), ((Component)_0024self__00242144).transform.position, Quaternion.identity, 1);
								_0024d_00242140.networkView.RPC("SetID", (RPCMode)6, new object[1] { _0024item_00242139.id });
								_0024d_00242140.networkView.RPC("SetD", (RPCMode)6, new object[1] { _0024item_00242139.d });
								_0024d_00242140.networkView.RPC("SetE", (RPCMode)6, new object[1] { _0024item_00242139.e });
								_0024d_00242140.networkView.RPC("SetQ", (RPCMode)6, new object[1] { _0024item_00242139.q });
							}
						}
						else if (MenuScript.pHat == 14)
						{
							_0024se_00242141 = Random.Range(0, 10);
							if (_0024se_00242141 == 0)
							{
								Network.Instantiate(Resources.Load("e/broodmother"), new Vector3(((Component)_0024self__00242144).transform.position.x, ((Component)_0024self__00242144).transform.position.y + 50f, 0f), Quaternion.identity, 0);
							}
						}
						((Component)_0024self__00242144).audio.PlayOneShot(_0024self__00242144.ow);
						canTakeDamage = false;
						_0024n2_00242142 = (GameObject)Network.Instantiate((Object)(GameObject)Resources.Load("TD1", typeof(GameObject)), ((Component)_0024self__00242144).transform.position, Quaternion.identity, 0);
						_0024n2_00242142.networkView.RPC("SDN", (RPCMode)2, new object[1] { _0024finalDMG_00242137 });
						_0024self__00242144.gameScript.TD(_0024finalDMG_00242137);
						_0024self__00242144.gameScript.LoadHearts();
						GameScript.canTakeDamage = false;
						((MonoBehaviour)_0024self__00242144).StartCoroutine_Auto(_0024self__00242144.GetHit());
						if (GameScript.HP >= 1)
						{
						...
						GameScript.HP = 0;
						_0024self__00242144.player.SendMessage("Die");
						isDead = true;
						_0024self__00242144.@base.animation.Play("dead");
					}
					goto IL_0346;
				case 2:
					canTakeDamage = true;
		...
		internal int _0024DMG_00242145;

		internal PlayerTriggerScript _0024self__00242146;

		public _0024TD_00242136(int DMG, PlayerTriggerScript self_)
		{
			_0024DMG_00242145 = DMG;
			_0024self__00242146 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024DMG_00242145, _0024self__00242146);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GetHit_00242147 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024815_00242148;

			internal Vector3 _0024_0024816_00242149;

			internal int _0024_0024817_00242150;

			internal Vector3 _0024_0024818_00242151;

			internal PlayerTriggerScript _0024self__00242152;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					((Component)_0024self__00242152).animation.Play();
					_0024self__00242152.gameScript.heartsObj.animation.Play();
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
					break;
				case 2:
				{
					((Component)_0024self__00242152).animation.Stop();
					_0024self__00242152.gameScript.heartsObj.animation.Stop();
					GameScript.canTakeDamage = true;
					int num = (_0024_0024815_00242148 = 0);
					Vector3 val = (_0024_0024816_00242149 = ((Component)_0024self__00242152).transform.localPosition);
					float num2 = (_0024_0024816_00242149.z = _0024_0024815_00242148);
					Vector3 val3 = (((Component)_0024self__00242152).transform.localPosition = _0024_0024816_00242149);
					int num3 = (_0024_0024817_00242150 = 20);
					Vector3 val4 = (_0024_0024818_00242151 = _0024self__00242152.gameScript.heartsObj.transform.localPosition);
					float num4 = (_0024_0024818_00242151.z = _0024_0024817_00242150);
					Vector3 val6 = (_0024self__00242152.gameScript.heartsObj.transform.localPosition = _0024_0024818_00242151);
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				}
				case 1:
		...
		internal PlayerTriggerScript _0024self__00242153;

		public _0024GetHit_00242147(PlayerTriggerScript self_)
		{
	...
	{
		return new _0024TD_00242136(DMG, this).GetEnumerator();
	}

	public override IEnumerator GetHit()
	{
		return new _0024GetHit_00242147(this).GetEnumerator();
	}
