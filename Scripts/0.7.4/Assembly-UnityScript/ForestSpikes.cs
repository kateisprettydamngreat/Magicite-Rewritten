...
public class ForestSpikes : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241422 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal ForestSpikes _0024self__00241423;
			...
			public override bool MoveNext()
			{
				...
				case 3:
					if (Network.isServer)
					{
						((Component)_0024self__00241423).networkView.RPC("pl", (RPCMode)6, new object[0]);
					}
		...
		internal ForestSpikes _0024self__00241424;

		public _0024Start_00241422(ForestSpikes self_)
		{
