...
public class DaggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241043 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal DaggerScript _0024self__00241044;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241044.t = ((Component)_0024self__00241044).transform;
					_0024self__00241044.rr = ((Component)_0024self__00241044).rigidbody;
					if (_0024self__00241044.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241044).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241044).gameObject);
					}
					else
					{
		...
		internal DaggerScript _0024self__00241045;

		public _0024Start_00241043(DaggerScript self_)
		{
	...
	{
		return new _0024Start_00241043(this).GetEnumerator();
	}
