...
public class FlameScriptt : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241419 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal FlameScriptt _0024self__00241420;
			...
			public override bool MoveNext()
			{
				...
				case 3:
					if (Network.isServer)
					{
						((Component)_0024self__00241420).networkView.RPC("pl", (RPCMode)6, new object[0]);
					}
		...
		internal FlameScriptt _0024self__00241421;

		public _0024Start_00241419(FlameScriptt self_)
		{
