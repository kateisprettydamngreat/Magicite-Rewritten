...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241046 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			internal MerchantScript _0024self__00241047;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241047).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241047.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241047).StartCoroutine_Auto(_0024self__00241047.Talkn(_0024self__00241047.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		internal MerchantScript _0024self__00241048;

		public _0024Start_00241046(MerchantScript self_)
		{
		...
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241048);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241049 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241050;

			internal MerchantScript _0024self__00241051;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241051.@base.animation.Play("t");
					_0024self__00241051.txtTalk.text = _0024s_00241050;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241051.txtTalk.text = string.Empty;
					_0024self__00241051.@base.animation.Play("i");
		...
		internal string _0024s_00241052;

		internal MerchantScript _0024self__00241053;

		public _0024Talkn_00241049(string s, MerchantScript self_)
		{
			_0024s_00241052 = s;
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241052, _0024self__00241053);
		}
	}
	...
	{
		return new _0024Talkn_00241049(s, this).GetEnumerator();
	}
