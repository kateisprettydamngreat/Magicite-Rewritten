...
public class ItemScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241749 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024647_00241750;

			internal Vector3 _0024_0024648_00241751;

			internal ItemScript _0024self__00241752;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241752.dropped)
					{
						_0024self__00241752.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024647_00241750 = Random.Range(5, 9));
						Vector3 val = (_0024_0024648_00241751 = _0024self__00241752.r.velocity);
						float num2 = (_0024_0024648_00241751.y = _0024_0024647_00241750);
						Vector3 val3 = (_0024self__00241752.r.velocity = _0024_0024648_00241751);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241752.@base.collider.enabled = true;
					_0024self__00241752.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(15f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241752).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241752).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241752).gameObject);
					}
		...
		internal ItemScript _0024self__00241753;

		public _0024Start_00241749(ItemScript self_)
		{
	...
	{
		return new _0024Start_00241749(this).GetEnumerator();
	}
