...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241000 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			internal MerchantScript _0024self__00241001;

			public _0024(MerchantScript self_)
			{
				_0024self__00241001 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241001).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241001.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241001).StartCoroutine_Auto(_0024self__00241001.Talkn(_0024self__00241001.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		internal MerchantScript _0024self__00241002;

		public _0024Start_00241000(MerchantScript self_)
		{
			_0024self__00241002 = self_;
		}

		public override IEnumerator<YieldInstruction> GetEnumerator()
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241002);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241003 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241004;

			internal MerchantScript _0024self__00241005;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241005.@base.animation.Play("t");
					_0024self__00241005.txtTalk.text = _0024s_00241004;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241005.txtTalk.text = string.Empty;
					_0024self__00241005.@base.animation.Play("i");
		...
		internal string _0024s_00241006;

		internal MerchantScript _0024self__00241007;

		public _0024Talkn_00241003(string s, MerchantScript self_)
		{
			_0024s_00241006 = s;
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241006, _0024self__00241007);
		}
	}
	...
	{
		return new _0024Start_00241000(this).GetEnumerator();
	}
	...
	{
		return new _0024Talkn_00241003(s, this).GetEnumerator();
	}
