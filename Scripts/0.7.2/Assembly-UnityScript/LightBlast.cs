...
public class LightBlast : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241678 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal LightBlast _0024self__00241679;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241679.t = ((Component)_0024self__00241679).transform;
					if (_0024self__00241679.isRight)
					{
					}
					((Component)_0024self__00241679).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241679).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241679).gameObject);
					}
		...
		internal LightBlast _0024self__00241680;

		public _0024Start_00241678(LightBlast self_)
		{
