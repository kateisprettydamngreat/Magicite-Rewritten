...
public class Poison : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242025 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal Poison _0024self__00242026;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					if (Network.isServer)
					{
						Network.RemoveRPCs(_0024self__00242026.parent.networkView.viewID);
						Network.Destroy(_0024self__00242026.parent.networkView.viewID);
					}
					goto IL_00a4;
				case 3:
					Object.Destroy((Object)(object)_0024self__00242026.parent.gameObject);
					goto IL_00a4;
				case 1:
					{
						result = 0;
		...
		internal Poison _0024self__00242027;

		public _0024Start_00242025(Poison self_)
		{
	...
	{
		return new _0024Start_00242025(this).GetEnumerator();
	}
