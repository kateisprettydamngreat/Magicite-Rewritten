...
public class ArrowScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241089 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal ArrowScript _0024self__00241090;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241090.t = ((Component)_0024self__00241090).transform;
					if (_0024self__00241090.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241090).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241090).gameObject);
					}
					else
					{
		...
		internal ArrowScript _0024self__00241091;

		public _0024Start_00241089(ArrowScript self_)
		{
	...
	{
		return new _0024Start_00241089(this).GetEnumerator();
	}
