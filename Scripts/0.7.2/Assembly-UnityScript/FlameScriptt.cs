...
public class FlameScriptt : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241373 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal FlameScriptt _0024self__00241374;
			...
			public override bool MoveNext()
			{
				...
				case 3:
					if (Network.isServer)
					{
						((Component)_0024self__00241374).networkView.RPC("pl", (RPCMode)6, new object[0]);
					}
		...
		internal FlameScriptt _0024self__00241375;

		public _0024Start_00241373(FlameScriptt self_)
		{
	...
	{
		return new _0024Start_00241373(this).GetEnumerator();
	}
