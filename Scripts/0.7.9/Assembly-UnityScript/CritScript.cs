...
public class CritScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241295 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal CritScript _0024self__00241296;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					_0024self__00241296.stop = true;
					if (MenuScript.multiplayer > 0)
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241296).gameObject, 0.5f);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241296).gameObject, 0.5f);
		...
		internal CritScript _0024self__00241297;

		public _0024Start_00241295(CritScript self_)
		{
