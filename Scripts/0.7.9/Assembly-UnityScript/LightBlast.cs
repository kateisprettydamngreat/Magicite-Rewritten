...
public class LightBlast : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241886 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal LightBlast _0024self__00241887;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241887.t = ((Component)_0024self__00241887).transform;
					if (_0024self__00241887.isRight)
					{
					}
					((Component)_0024self__00241887).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241887).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241887).gameObject);
					}
		...
		internal LightBlast _0024self__00241888;

		public _0024Start_00241886(LightBlast self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241888);
		}
	}
	...
	{
		return new _0024Start_00241886(this).GetEnumerator();
	}
