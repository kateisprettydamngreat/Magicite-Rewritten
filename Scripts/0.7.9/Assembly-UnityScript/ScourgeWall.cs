...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242375 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242376;

			internal ScourgeWall _0024self__00242377;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242377).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242376 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242377.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242378;

		public _0024ShootStuff_00242375(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242379 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal ScourgeWall _0024self__00242381;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242381.hp -= _0024dmg_00242380;
		...
		internal int _0024dmg_00242382;

		internal ScourgeWall _0024self__00242383;

		public _0024TDN_00242379(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242382 = dmg;
			_0024self__00242383 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242382, _0024self__00242383);
		}
	}
	...
	{
		return new _0024ShootStuff_00242375(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242379(dmg, this).GetEnumerator();
	}
