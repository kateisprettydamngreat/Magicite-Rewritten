...
public class BlueWorm : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Action_00241240 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00241241;

			internal Vector3 _0024pos_00241242;

			internal BlueWorm _0024self__00241243;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024i_00241241 = default(int);
					_0024pos_00241242 = default(Vector3);
					goto case 5;
				case 5:
				...
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						if (Network.isServer)
						{
							((Component)_0024self__00241243).networkView.RPC("A", (RPCMode)2, new object[0]);
						}
					}
					else
					{
				...
				case 1:
					...
					IL_0182:
					if (_0024i_00241241 < 6)
					{
						_0024pos_00241242 = new Vector3(_0024self__00241243.t.position.x + (float)Random.Range(-8, 8), _0024self__00241243.t.position.y + 28f, 0f);
						if (MenuScript.multiplayer > 0)
						{
							Network.Instantiate(Resources.Load("rckW"), _0024pos_00241242, Quaternion.identity, 0);
						}
						else
						{
							Object.Instantiate(Resources.Load("rckW"), _0024pos_00241242, Quaternion.identity);
						}
		...
		internal BlueWorm _0024self__00241244;

		public _0024Action_00241240(BlueWorm self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241244);
		}
	}
	...
	{
		return new _0024Action_00241240(this).GetEnumerator();
	}
}
