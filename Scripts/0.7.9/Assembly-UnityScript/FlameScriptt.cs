...
public class FlameScriptt : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241487 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal FlameScriptt _0024self__00241488;

			public _0024(FlameScriptt self_)
			{
				_0024self__00241488 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				case 3:
					if (Network.isServer)
					{
						((Component)_0024self__00241488).networkView.RPC("pl", (RPCMode)6, new object[0]);
					}
		...
		internal FlameScriptt _0024self__00241489;

		public _0024Start_00241487(FlameScriptt self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241489);
		}
	}
