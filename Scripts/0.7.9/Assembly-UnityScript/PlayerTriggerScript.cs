...
public class PlayerTriggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TD_00242267 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024finalDMG_00242268;

			internal int _0024poo_00242269;

			internal Item _0024item_00242270;

			internal GameObject _0024d_00242271;

			internal int _0024se_00242272;

			internal GameObject _0024n2_00242273;

			internal int _0024DMG_00242274;

			internal PlayerTriggerScript _0024self__00242275;

			public _0024(int DMG, PlayerTriggerScript self_)
			{
				_0024DMG_00242274 = DMG;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024finalDMG_00242268 = _0024DMG_00242274 - ShieldDEF;
					if (_0024finalDMG_00242268 < 1)
					{
						_0024finalDMG_00242268 = 1;
					}
					if (MenuScript.multiplayer > 0 && ((Component)_0024self__00242275).networkView.isMine && canTakeDamage && !GameScript.win)
					{
						if (MenuScript.pHat == 13)
						{
							_0024poo_00242269 = Random.Range(0, 5);
							if (_0024poo_00242269 == 0)
							{
								_0024item_00242270 = new Item(Random.Range(9, 12), 1, new int[4], 0f, null);
								_0024d_00242271 = (GameObject)Network.Instantiate(Resources.Load("item"), ((Component)_0024self__00242275).transform.position, Quaternion.identity, 1);
								_0024d_00242271.networkView.RPC("SetID", (RPCMode)6, new object[1] { _0024item_00242270.id });
								_0024d_00242271.networkView.RPC("SetD", (RPCMode)6, new object[1] { _0024item_00242270.d });
								_0024d_00242271.networkView.RPC("SetE", (RPCMode)6, new object[1] { _0024item_00242270.e });
								_0024d_00242271.networkView.RPC("SetQ", (RPCMode)6, new object[1] { _0024item_00242270.q });
							}
						}
						else if (MenuScript.pHat == 14)
						{
							_0024se_00242272 = Random.Range(0, 10);
							if (_0024se_00242272 == 0)
							{
								Network.Instantiate(Resources.Load("e/broodmother"), new Vector3(((Component)_0024self__00242275).transform.position.x, ((Component)_0024self__00242275).transform.position.y + 50f, 0f), Quaternion.identity, 0);
							}
						}
						((Component)_0024self__00242275).audio.PlayOneShot(_0024self__00242275.ow);
						canTakeDamage = false;
						_0024n2_00242273 = (GameObject)Network.Instantiate((Object)(GameObject)Resources.Load("TD1", typeof(GameObject)), ((Component)_0024self__00242275).transform.position, Quaternion.identity, 0);
						_0024n2_00242273.networkView.RPC("SDN", (RPCMode)2, new object[1] { _0024finalDMG_00242268 });
						_0024self__00242275.gameScript.TD(_0024finalDMG_00242268);
						_0024self__00242275.gameScript.LoadHearts();
						GameScript.canTakeDamage = false;
						((MonoBehaviour)_0024self__00242275).StartCoroutine_Auto(_0024self__00242275.GetHit());
						if (GameScript.HP >= 1)
						{
						...
						GameScript.HP = 0;
						_0024self__00242275.player.SendMessage("Die");
						isDead = true;
						_0024self__00242275.@base.animation.Play("dead");
					}
					goto IL_0346;
				case 2:
					canTakeDamage = true;
		...
		internal int _0024DMG_00242276;

		internal PlayerTriggerScript _0024self__00242277;

		public _0024TD_00242267(int DMG, PlayerTriggerScript self_)
		{
			_0024DMG_00242276 = DMG;
			_0024self__00242277 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024DMG_00242276, _0024self__00242277);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GetHit_00242278 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024859_00242279;

			internal Vector3 _0024_0024860_00242280;

			internal int _0024_0024861_00242281;

			internal Vector3 _0024_0024862_00242282;

			internal PlayerTriggerScript _0024self__00242283;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					((Component)_0024self__00242283).animation.Play();
					_0024self__00242283.gameScript.heartsObj.animation.Play();
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
					break;
				case 2:
				{
					((Component)_0024self__00242283).animation.Stop();
					_0024self__00242283.gameScript.heartsObj.animation.Stop();
					GameScript.canTakeDamage = true;
					int num = (_0024_0024859_00242279 = 0);
					Vector3 val = (_0024_0024860_00242280 = ((Component)_0024self__00242283).transform.localPosition);
					float num2 = (_0024_0024860_00242280.z = _0024_0024859_00242279);
					Vector3 val3 = (((Component)_0024self__00242283).transform.localPosition = _0024_0024860_00242280);
					int num3 = (_0024_0024861_00242281 = 20);
					Vector3 val4 = (_0024_0024862_00242282 = _0024self__00242283.gameScript.heartsObj.transform.localPosition);
					float num4 = (_0024_0024862_00242282.z = _0024_0024861_00242281);
					Vector3 val6 = (_0024self__00242283.gameScript.heartsObj.transform.localPosition = _0024_0024862_00242282);
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				}
				case 1:
		...
		internal PlayerTriggerScript _0024self__00242284;

		public _0024GetHit_00242278(PlayerTriggerScript self_)
		{
	...
	{
		return new _0024TD_00242267(DMG, this).GetEnumerator();
	}

	public override IEnumerator GetHit()
	{
		return new _0024GetHit_00242278(this).GetEnumerator();
	}
