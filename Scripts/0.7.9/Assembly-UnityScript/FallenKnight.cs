...
public class FallenKnight : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024T_00241454 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024581_00241455;

			internal Quaternion _0024_0024582_00241456;

			internal int _0024_0024583_00241457;

			internal Quaternion _0024_0024584_00241458;

			internal FallenKnight _0024self__00241459;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241459.turning && !_0024self__00241459.ATKING)
					{
						_0024self__00241459.turning = true;
						if (_0024self__00241459.e.transform.rotation.y != 0f)
						{
							int num = (_0024_0024581_00241455 = 0);
							Quaternion val = (_0024_0024582_00241456 = _0024self__00241459.e.transform.rotation);
							float num2 = (_0024_0024582_00241456.y = _0024_0024581_00241455);
							Quaternion val3 = (_0024self__00241459.e.transform.rotation = _0024_0024582_00241456);
							if (MenuScript.multiplayer > 0)
							{
								((Component)_0024self__00241459).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
							}
						}
						else
						{
							int num3 = (_0024_0024583_00241457 = 180);
							Quaternion val4 = (_0024_0024584_00241458 = _0024self__00241459.e.transform.rotation);
							float num4 = (_0024_0024584_00241458.y = _0024_0024583_00241457);
							Quaternion val6 = (_0024self__00241459.e.transform.rotation = _0024_0024584_00241458);
							if (MenuScript.multiplayer > 0)
							{
								((Component)_0024self__00241459).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
							}
						}
						_0024self__00241459.spd *= -1;
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(1f)) ? 1 : 0);
						break;
					}
					goto IL_01cf;
				case 2:
					_0024self__00241459.turning = false;
					goto IL_01cf;
				case 1:
					{
						result = 0;
		...
		internal FallenKnight _0024self__00241460;

		public _0024T_00241454(FallenKnight self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Attack_00241461 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024585_00241462;

			internal Quaternion _0024_0024586_00241463;

			internal int _0024_0024587_00241464;

			internal Quaternion _0024_0024588_00241465;

			internal int _0024dir_00241466;

			internal FallenKnight _0024self__00241467;

			public _0024(int dir, FallenKnight self_)
			{
				_0024dir_00241466 = dir;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241467.ATKING)
					{
						_0024self__00241467.ATKING = true;
						if (_0024dir_00241466 == 0)
						{
							if (MenuScript.multiplayer > 0)
							{
								((Component)_0024self__00241467).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
							...
							{
								int num = (_0024_0024585_00241462 = 0);
								Quaternion val = (_0024_0024586_00241463 = _0024self__00241467.e.transform.rotation);
								float num2 = (_0024_0024586_00241463.y = _0024_0024585_00241462);
								Quaternion val3 = (_0024self__00241467.e.transform.rotation = _0024_0024586_00241463);
								_0024self__00241467.@base.animation.Play("a");
						...
						{
							int num3 = (_0024_0024587_00241464 = 180);
							Quaternion val4 = (_0024_0024588_00241465 = _0024self__00241467.e.transform.rotation);
							float num4 = (_0024_0024588_00241465.y = _0024_0024587_00241464);
							Quaternion val6 = (_0024self__00241467.e.transform.rotation = _0024_0024588_00241465);
							_0024self__00241467.@base.animation.Play("a");
					...
					goto IL_03a6;
				case 2:
					_0024self__00241467.spd = -10;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 3:
					_0024self__00241467.spd = 0;
					_0024self__00241467.@base.animation.Play("i");
					goto IL_0386;
				case 4:
					_0024self__00241467.spd = -10;
				...
				case 9:
					...
					goto IL_0386;
				case 10:
					_0024self__00241467.ATKING = false;
					goto IL_03a6;
				case 1:
					{
						result = 0;
		...
		internal int _0024dir_00241468;

		internal FallenKnight _0024self__00241469;

		public _0024Attack_00241461(int dir, FallenKnight self_)
		{
			_0024dir_00241468 = dir;
			_0024self__00241469 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dir_00241468, _0024self__00241469);
		}
	}
	...
	{
		return new _0024T_00241454(this).GetEnumerator();
	}
	...
	{
		return new _0024Attack_00241461(dir, this).GetEnumerator();
	}
