...
public class ItemScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241843 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024681_00241844;

			internal Vector3 _0024_0024682_00241845;

			internal ItemScript _0024self__00241846;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241846.dropped)
					{
						_0024self__00241846.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024681_00241844 = Random.Range(5, 9));
						Vector3 val = (_0024_0024682_00241845 = _0024self__00241846.r.velocity);
						float num2 = (_0024_0024682_00241845.y = _0024_0024681_00241844);
						Vector3 val3 = (_0024self__00241846.r.velocity = _0024_0024682_00241845);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241846.@base.collider.enabled = true;
					_0024self__00241846.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(15f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241846).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241846).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241846).gameObject);
					}
		...
		internal ItemScript _0024self__00241847;

		public _0024Start_00241843(ItemScript self_)
		{
	...
	{
		return new _0024Start_00241843(this).GetEnumerator();
	}
