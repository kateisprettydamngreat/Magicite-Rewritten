...
public class DaggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241313 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal DaggerScript _0024self__00241314;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241314.t = ((Component)_0024self__00241314).transform;
					_0024self__00241314.rr = ((Component)_0024self__00241314).rigidbody;
					if (_0024self__00241314.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241314).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241314).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241314).gameObject);
					}
		...
		internal DaggerScript _0024self__00241315;

		public _0024Start_00241313(DaggerScript self_)
		{
	...
	{
		return new _0024Start_00241313(this).GetEnumerator();
	}
