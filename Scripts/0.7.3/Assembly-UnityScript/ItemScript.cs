...
public class ItemScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241640 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal int _0024_0024613_00241641;

			internal Vector3 _0024_0024614_00241642;

			internal ItemScript _0024self__00241643;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241643.dropped)
					{
						_0024self__00241643.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024613_00241641 = Random.Range(5, 9));
						Vector3 val = (_0024_0024614_00241642 = _0024self__00241643.r.velocity);
						float num2 = (_0024_0024614_00241642.y = _0024_0024613_00241641);
						Vector3 val3 = (_0024self__00241643.r.velocity = _0024_0024614_00241642);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241643.@base.collider.enabled = true;
					_0024self__00241643.can = true;
		...
		internal ItemScript _0024self__00241644;

		public _0024Start_00241640(ItemScript self_)
		{
