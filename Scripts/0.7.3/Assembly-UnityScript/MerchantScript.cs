...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241003 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			internal MerchantScript _0024self__00241004;

			public _0024(MerchantScript self_)
			{
				_0024self__00241004 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241004).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241004.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241004).StartCoroutine_Auto(_0024self__00241004.Talkn(_0024self__00241004.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		public _0024Start_00241003(MerchantScript self_)
		{
		...
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241005);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241006 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241007;

			internal MerchantScript _0024self__00241008;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241008.@base.animation.Play("t");
					_0024self__00241008.txtTalk.text = _0024s_00241007;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241008.txtTalk.text = string.Empty;
					_0024self__00241008.@base.animation.Play("i");
		...
		internal string _0024s_00241009;

		internal MerchantScript _0024self__00241010;

		public _0024Talkn_00241006(string s, MerchantScript self_)
		{
			_0024s_00241009 = s;
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241009, _0024self__00241010);
		}
	}
	...
	{
		return new _0024Start_00241003(this).GetEnumerator();
	}
	...
	{
		return new _0024Talkn_00241006(s, this).GetEnumerator();
	}
