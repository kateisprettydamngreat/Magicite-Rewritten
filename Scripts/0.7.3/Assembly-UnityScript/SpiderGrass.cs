...
public class SpiderGrass : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeRight_00242320 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024881_00242321;

			internal Vector3 _0024_0024882_00242322;

			internal SpiderGrass _0024self__00242323;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242323.charging && MenuScript.multiplayer == 1)
					{
						int num = (_0024_0024881_00242321 = 20);
						Vector3 val = (_0024_0024882_00242322 = _0024self__00242323.r.velocity);
						float num2 = (_0024_0024882_00242322.y = _0024_0024881_00242321);
						Vector3 val3 = (_0024self__00242323.r.velocity = _0024_0024882_00242322);
						_0024self__00242323.charging = true;
						((Component)_0024self__00242323).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
						((Component)_0024self__00242323).networkView.RPC("ATK", (RPCMode)2, new object[0]);
						_0024self__00242323.spdd = 5;
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
						break;
					}
					goto IL_011c;
				case 2:
					((Component)_0024self__00242323).networkView.RPC("IDLE", (RPCMode)2, new object[0]);
					_0024self__00242323.charging = false;
					goto IL_011c;
				case 1:
					{
						result = 0;
		...
		internal SpiderGrass _0024self__00242324;

		public _0024ChargeRight_00242320(SpiderGrass self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeLeft_00242325 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024883_00242326;

			internal Vector3 _0024_0024884_00242327;

			internal SpiderGrass _0024self__00242328;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					{
						int num = (_0024_0024883_00242326 = 20);
						Vector3 val = (_0024_0024884_00242327 = _0024self__00242328.r.velocity);
						float num2 = (_0024_0024884_00242327.y = _0024_0024883_00242326);
						Vector3 val3 = (_0024self__00242328.r.velocity = _0024_0024884_00242327);
		...
		internal SpiderGrass _0024self__00242329;

		public _0024ChargeLeft_00242325(SpiderGrass self_)
		{
	...
	{
		return new _0024ChargeRight_00242320(this).GetEnumerator();
	}

	public override IEnumerator ChargeLeft()
	{
		return new _0024ChargeLeft_00242325(this).GetEnumerator();
	}
