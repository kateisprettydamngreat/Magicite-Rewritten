...
public class AttackCube : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241095 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal AttackCube _0024self__00241096;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!Object.op_Implicit((Object)(object)_0024self__00241096.gameScript))
					{
						_0024self__00241096.gameScript = (GameScript)(object)GameObject.Find("GameManager").GetComponent("GameScript");
					}
		...
		internal AttackCube _0024self__00241097;

		public _0024Start_00241095(AttackCube self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Anim_00241098 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00241099;

			internal int _0024_0024365_00241100;

			internal Vector2 _0024_0024366_00241101;

			internal float _0024_0024367_00241102;

			internal Vector2 _0024_0024368_00241103;

			internal int _0024_0024369_00241104;

			internal Vector2 _0024_0024370_00241105;

			internal AttackCube _0024self__00241106;

			public _0024(AttackCube self_)
			{
				_0024self__00241106 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				default:
				{
					_0024i_00241099 = default(int);
					int num = (_0024_0024365_00241100 = 0);
					Vector2 val = (_0024_0024366_00241101 = _0024self__00241106.atkAnim.renderer.material.mainTextureOffset);
					float num2 = (_0024_0024366_00241101.x = _0024_0024365_00241100);
					Vector2 val3 = (_0024self__00241106.atkAnim.renderer.material.mainTextureOffset = _0024_0024366_00241101);
					_0024i_00241099 = 0;
					goto IL_0154;
				}
				case 2:
				...
				case 1:
					...
					IL_0154:
					if (_0024i_00241099 < 3)
					{
						float num3 = (_0024_0024367_00241102 = _0024self__00241106.atkAnim.renderer.material.mainTextureOffset.x + 0.25f);
						Vector2 val4 = (_0024_0024368_00241103 = _0024self__00241106.atkAnim.renderer.material.mainTextureOffset);
						float num4 = (_0024_0024368_00241103.x = _0024_0024367_00241102);
						Vector2 val6 = (_0024self__00241106.atkAnim.renderer.material.mainTextureOffset = _0024_0024368_00241103);
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.05f)) ? 1 : 0);
						break;
					}
					num5 = (_0024_0024369_00241104 = 0);
					val7 = (_0024_0024370_00241105 = _0024self__00241106.atkAnim.renderer.material.mainTextureOffset);
					num6 = (_0024_0024370_00241105.x = _0024_0024369_00241104);
					val9 = (_0024self__00241106.atkAnim.renderer.material.mainTextureOffset = _0024_0024370_00241105);
		...
		internal AttackCube _0024self__00241107;

		public _0024Anim_00241098(AttackCube self_)
		{
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241107);
		}
	}
	...
	{
		return new _0024Start_00241095(this).GetEnumerator();
	}
	...
	{
		return new _0024Anim_00241098(this).GetEnumerator();
	}
