...
public class GiantBug : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Attack_00241597 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal GiantBug _0024self__00241598;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					if (Object.op_Implicit((Object)(object)_0024self__00241598.player) && MenuScript.multiplayer == 1)
					{
						((Component)_0024self__00241598).networkView.RPC("SpeedUp", (RPCMode)2, new object[0]);
						_0024self__00241598.curVector = _0024self__00241598.player.transform.position - _0024self__00241598.t.position;
						if (!(_0024self__00241598.player.transform.position.x <= _0024self__00241598.t.position.x))
						{
						...
						_0024self__00241598.atking = true;
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2.5f)) ? 1 : 0);
						break;
					}
					goto IL_0165;
				case 3:
					((Component)_0024self__00241598).networkView.RPC("SpeedDown", (RPCMode)2, new object[0]);
					goto IL_0165;
				case 1:
					{
						result = 0;
					...
					IL_0165:
					_0024self__00241598.atking = false;
					goto default;
				}
		...
		internal GiantBug _0024self__00241599;

		public _0024Attack_00241597(GiantBug self_)
		{
	...
	{
		return new _0024Attack_00241597(this).GetEnumerator();
	}
