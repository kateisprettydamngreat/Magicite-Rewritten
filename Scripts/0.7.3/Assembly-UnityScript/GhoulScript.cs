...
public class GhoulScript : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Summon_00241590 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal GameObject _0024g_00241591;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024g_00241591 = null;
					goto IL_0023;
				case 2:
					if (_0024self__00241592.atking && Object.op_Implicit((Object)(object)_0024self__00241592.player) && _0024self__00241592.canFire)
					{
						if (MenuScript.multiplayer > 0)
						{
							_0024g_00241591 = (GameObject)Network.Instantiate(Resources.Load("haz/ghoulFire"), ((Component)_0024self__00241592).transform.position, Quaternion.identity, 0);
							_0024g_00241591.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024self__00241592.player.transform.position });
						}
						else
						{
							_0024g_00241591 = (GameObject)Object.Instantiate(Resources.Load("haz/ghoulFire"), ((Component)_0024self__00241592).transform.position, Quaternion.identity);
							_0024g_00241591.SendMessage("Set", (object)_0024self__00241592.player.transform.position);
						}
					}
					goto IL_0023;
				case 1:
		...
		public _0024Summon_00241590(GhoulScript self_)
		{
	...
	internal sealed class _0024Attack_00241594 : GenericGenerator<WaitForSeconds>
	{
		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal GhoulScript _0024self__00241595;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					if (Object.op_Implicit((Object)(object)_0024self__00241595.player))
					{
		...
		internal GhoulScript _0024self__00241596;

		public _0024Attack_00241594(GhoulScript self_)
		{
	...
	{
		return new _0024Summon_00241590(this).GetEnumerator();
	}
