...
public class ArrowScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241092 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal ArrowScript _0024self__00241093;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241093.t = ((Component)_0024self__00241093).transform;
					if (_0024self__00241093.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241093).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241093).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241093).gameObject);
					}
		...
		internal ArrowScript _0024self__00241094;

		public _0024Start_00241092(ArrowScript self_)
		{
