...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242122 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal ScourgeWall _0024self__00242124;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242124).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242123 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242124.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242125;

		public _0024ShootStuff_00242122(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242126 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal ScourgeWall _0024self__00242128;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242128.hp -= _0024dmg_00242127;
		...
		internal int _0024dmg_00242129;

		internal ScourgeWall _0024self__00242130;

		public _0024TDN_00242126(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242129 = dmg;
			_0024self__00242130 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242129, _0024self__00242130);
		}
	}
	...
	{
		return new _0024ShootStuff_00242122(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242126(dmg, this).GetEnumerator();
	}
