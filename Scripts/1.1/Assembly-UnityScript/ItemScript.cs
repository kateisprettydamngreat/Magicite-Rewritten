...
public class ItemScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241990 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024704_00241991;

			internal Vector3 _0024_0024705_00241992;

			internal ItemScript _0024self__00241993;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241993.dropped)
					{
						_0024self__00241993.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024704_00241991 = Random.Range(5, 9));
						Vector3 val = (_0024_0024705_00241992 = _0024self__00241993.r.velocity);
						float num2 = (_0024_0024705_00241992.y = _0024_0024704_00241991);
						Vector3 val3 = (_0024self__00241993.r.velocity = _0024_0024705_00241992);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241993.@base.collider.enabled = true;
					_0024self__00241993.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(15f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241993).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241993).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241993).gameObject);
					}
		...
		internal ItemScript _0024self__00241994;

		public _0024Start_00241990(ItemScript self_)
		{
	...
	{
		return new _0024Start_00241990(this).GetEnumerator();
	}
