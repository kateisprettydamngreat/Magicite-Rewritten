...
public class AttackCube : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241309 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal AttackCube _0024self__00241310;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!Object.op_Implicit((Object)(object)_0024self__00241310.gameScript))
					{
						_0024self__00241310.gameScript = (GameScript)(object)GameObject.Find("GameManager").GetComponent("GameScript");
					}
		...
		internal AttackCube _0024self__00241311;

		public _0024Start_00241309(AttackCube self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Anim_00241312 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00241313;

			internal int _0024_0024428_00241314;

			internal Vector2 _0024_0024429_00241315;

			internal float _0024_0024430_00241316;

			internal Vector2 _0024_0024431_00241317;

			internal int _0024_0024432_00241318;

			internal Vector2 _0024_0024433_00241319;

			internal AttackCube _0024self__00241320;
			...
			public override bool MoveNext()
			{
				...
				default:
				{
					_0024i_00241313 = default(int);
					int num = (_0024_0024428_00241314 = 0);
					Vector2 val = (_0024_0024429_00241315 = _0024self__00241320.atkAnim.renderer.material.mainTextureOffset);
					float num2 = (_0024_0024429_00241315.x = _0024_0024428_00241314);
					Vector2 val3 = (_0024self__00241320.atkAnim.renderer.material.mainTextureOffset = _0024_0024429_00241315);
					_0024i_00241313 = 0;
					goto IL_0154;
				}
				case 2:
				...
				case 1:
					...
					IL_0154:
					if (_0024i_00241313 < 3)
					{
						float num3 = (_0024_0024430_00241316 = _0024self__00241320.atkAnim.renderer.material.mainTextureOffset.x + 0.25f);
						Vector2 val4 = (_0024_0024431_00241317 = _0024self__00241320.atkAnim.renderer.material.mainTextureOffset);
						float num4 = (_0024_0024431_00241317.x = _0024_0024430_00241316);
						Vector2 val6 = (_0024self__00241320.atkAnim.renderer.material.mainTextureOffset = _0024_0024431_00241317);
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.05f)) ? 1 : 0);
						break;
					}
					num5 = (_0024_0024432_00241318 = 0);
					val7 = (_0024_0024433_00241319 = _0024self__00241320.atkAnim.renderer.material.mainTextureOffset);
					num6 = (_0024_0024433_00241319.x = _0024_0024432_00241318);
					val9 = (_0024self__00241320.atkAnim.renderer.material.mainTextureOffset = _0024_0024433_00241319);
		...
		internal AttackCube _0024self__00241321;

		public _0024Anim_00241312(AttackCube self_)
		{
	...
	{
		return new _0024Anim_00241312(this).GetEnumerator();
	}
