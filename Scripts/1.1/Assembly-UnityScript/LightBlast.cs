...
public class LightBlast : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242040 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal LightBlast _0024self__00242041;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242041.t = ((Component)_0024self__00242041).transform;
					if (_0024self__00242041.isRight)
					{
					}
					((Component)_0024self__00242041).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00242041).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242041).gameObject);
					}
		...
		internal LightBlast _0024self__00242042;

		public _0024Start_00242040(LightBlast self_)
		{
	...
	{
		return new _0024Start_00242040(this).GetEnumerator();
	}
