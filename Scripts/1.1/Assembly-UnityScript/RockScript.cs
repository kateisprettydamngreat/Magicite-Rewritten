...
public class RockScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Die_00242479 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal RockScript _0024self__00242480;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						Network.Destroy(((Component)_0024self__00242480).networkView.viewID);
					}
		...
		internal RockScript _0024self__00242481;

		public _0024Die_00242479(RockScript self_)
		{
	...
	{
		return new _0024Die_00242479(this).GetEnumerator();
	}
