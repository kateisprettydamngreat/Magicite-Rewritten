...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242556 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242557;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242558).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242557 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242558.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242559;

		public _0024ShootStuff_00242556(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242560 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242561;

			internal ScourgeWall _0024self__00242562;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242561 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242562.hp -= _0024dmg_00242561;
		...
		internal int _0024dmg_00242563;

		internal ScourgeWall _0024self__00242564;

		public _0024TDN_00242560(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242563 = dmg;
			_0024self__00242564 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242563, _0024self__00242564);
		}
	}
	...
	{
		return new _0024ShootStuff_00242556(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242560(dmg, this).GetEnumerator();
	}
