...
public class king : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Attack_00243078 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal Vector3 _0024pp2_00243079;

			internal GameObject _0024g_00243080;

			internal king _0024self__00243081;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00243081.ATKING = true;
					_0024self__00243081.atking = false;
					_0024self__00243081.MOVING = false;
				...
				case 2:
					...
					break;
				case 3:
					((Component)_0024self__00243081).networkView.RPC("ATK2", (RPCMode)2, new object[0]);
					if (Object.op_Implicit((Object)(object)_0024self__00243081.player))
					{
						_0024pp2_00243079 = _0024self__00243081.player.transform.position;
						if (MenuScript.multiplayer > 0)
						{
							if (MenuScript.multiplayer == 1)
							{
								_0024g_00243080 = null;
								_0024g_00243080 = (GameObject)Network.Instantiate(Resources.Load("haz/whelpFire"), ((Component)_0024self__00243081).transform.position, Quaternion.identity, 0);
								_0024g_00243080.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024pp2_00243079 });
							}
							_0024g_00243080.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024pp2_00243079 });
						}
					}
				...
				case 4:
					if (Object.op_Implicit((Object)(object)_0024self__00243081.player))
					{
						_0024self__00243081.curVector = _0024self__00243081.player.transform.position - _0024self__00243081.t.position;
						if (!(_0024self__00243081.player.transform.position.x <= ((Component)_0024self__00243081).transform.position.x))
						{
							if (MenuScript.multiplayer > 0)
							{
						...
						{
							((Component)_0024self__00243081).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
						}
					}
					_0024self__00243081.MOVING = true;
		...
		internal king _0024self__00243082;

		public _0024Attack_00243078(king self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ATK2_00243083 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00243084;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024i_00243084 = default(int);
					_0024self__00243085.CRAZE = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					for (_0024i_00243084 = 0; _0024i_00243084 < 4; _0024i_00243084++)
					{
						_0024self__00243085.swords[_0024i_00243084].collider.enabled = true;
					}
				...
				case 3:
					for (_0024i_00243084 = 0; _0024i_00243084 < 4; _0024i_00243084++)
					{
						_0024self__00243085.swords[_0024i_00243084].collider.enabled = false;
					}
					_0024self__00243085.CRAZE = false;
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				case 1:
					result = 0;
		...
		public _0024ATK2_00243083(king self_)
		{
	...
	{
		return new _0024Attack_00243078(this).GetEnumerator();
	}
	...
	{
		return new _0024ATK2_00243083(this).GetEnumerator();
	}
}
