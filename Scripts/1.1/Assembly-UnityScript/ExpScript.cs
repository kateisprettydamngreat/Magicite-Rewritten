...
public class ExpScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241578 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal ExpScript _0024self__00241579;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					_0024self__00241579.@base.collider.enabled = true;
					_0024self__00241579.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(10f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241579).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241579).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241579).gameObject);
					}
		...
		internal ExpScript _0024self__00241580;

		public _0024Start_00241578(ExpScript self_)
		{
