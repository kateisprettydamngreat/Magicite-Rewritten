		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				case 9:
					...
					goto IL_2369;
				case 10:
					mouse_poss = UnityEngine.Input.mousePosition;
					object_poss = Camera.main.WorldToScreenPoint(player.transform.position);
					mouse_poss.z = -20f;
					mouse_poss.x -= object_poss.x;
					mouse_poss.y -= object_poss.y;
					anglee = Mathf.Atan2(mouse_poss.y, mouse_poss.x) * 57.29578f;
					arr = (GameObject)Network.Instantiate(Resources.Load("skill/crossBolt"), player.transform.position, Quaternion.Euler(new Vector3(0f, 0f, anglee)), 0);
					fff = 2 * (DEX + DEXBonus + drumDEX + 20);
					arr.GetComponent<NetworkView>().RPC("SetN", RPCMode.All, fff);
					goto IL_2369;
				case 11:
					mouse_pos = UnityEngine.Input.mousePosition;
					object_pos = Camera.main.WorldToScreenPoint(player.transform.position);
				...
				case 12:
					...
					f_.SendMessage("Set", MAXMAG + drumMAG);
					self_.GUImana.GetComponent<Animation>().Play();
					goto IL_2369;
				case 13:
					bo_ = (GameObject)Network.Instantiate(Resources.Load("proj/bolt"), player.transform.position, Quaternion.identity, 0);
					bo_.SendMessage("Set", MAXMAG + drumMAG);
					self_.GUImana.GetComponent<Animation>().Play();
					goto IL_2369;
				case 14:
				...
				case 1:
					...
					goto case 1;
					IL_2369:
					self_.RefreshActionBar();
					self_.UpdateCharacterWeapon();
