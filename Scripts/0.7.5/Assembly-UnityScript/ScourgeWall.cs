...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242303 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242304;

			internal ScourgeWall _0024self__00242305;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242305).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242304 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242305.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242306;

		public _0024ShootStuff_00242303(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242307 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242308;

			internal ScourgeWall _0024self__00242309;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242308 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242309.hp -= _0024dmg_00242308;
		...
		internal int _0024dmg_00242310;

		internal ScourgeWall _0024self__00242311;

		public _0024TDN_00242307(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242310 = dmg;
			_0024self__00242311 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242310, _0024self__00242311);
		}
	}
	...
	{
		return new _0024ShootStuff_00242303(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242307(dmg, this).GetEnumerator();
	}
