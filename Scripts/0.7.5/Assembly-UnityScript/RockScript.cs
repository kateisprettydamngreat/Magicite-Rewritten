...
public class RockScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Die_00242219 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal RockScript _0024self__00242220;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						Network.Destroy(((Component)_0024self__00242220).networkView.viewID);
					}
		...
		internal RockScript _0024self__00242221;

		public _0024Die_00242219(RockScript self_)
		{
	...
	{
		return new _0024Die_00242219(this).GetEnumerator();
	}
