...
public class LightBlast : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241851 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal LightBlast _0024self__00241852;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241852.t = ((Component)_0024self__00241852).transform;
					if (_0024self__00241852.isRight)
					{
					}
					((Component)_0024self__00241852).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241852).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241852).gameObject);
					}
		...
		internal LightBlast _0024self__00241853;

		public _0024Start_00241851(LightBlast self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241853);
		}
	}
	...
	{
		return new _0024Start_00241851(this).GetEnumerator();
	}
