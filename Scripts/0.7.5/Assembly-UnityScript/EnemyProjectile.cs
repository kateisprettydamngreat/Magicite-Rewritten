...
public class EnemyProjectile : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241306 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal EnemyProjectile _0024self__00241307;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241307).gameObject, 5f);
					}
					goto IL_0081;
				case 2:
					Network.Destroy(((Component)_0024self__00241307).networkView.viewID);
					goto IL_0081;
				case 1:
					{
						result = 0;
		...
		internal EnemyProjectile _0024self__00241308;

		public _0024Start_00241306(EnemyProjectile self_)
		{
