...
public class ForestSpikes : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241462 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal ForestSpikes _0024self__00241463;
			...
			public override bool MoveNext()
			{
				...
				case 3:
					if (Network.isServer)
					{
						((Component)_0024self__00241463).networkView.RPC("pl", (RPCMode)6, new object[0]);
					}
		...
		internal ForestSpikes _0024self__00241464;

		public _0024Start_00241462(ForestSpikes self_)
		{
	...
	{
		return new _0024Start_00241462(this).GetEnumerator();
	}
