...
public class RockScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Die_00242523 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal RockScript _0024self__00242524;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						Network.Destroy(((Component)_0024self__00242524).networkView.viewID);
					}
		...
		internal RockScript _0024self__00242525;

		public _0024Die_00242523(RockScript self_)
		{
	...
	{
		return new _0024Die_00242523(this).GetEnumerator();
	}
