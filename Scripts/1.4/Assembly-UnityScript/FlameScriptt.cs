...
public class FlameScriptt : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241653 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				case 3:
					if (Network.isServer)
					{
						((Component)_0024self__00241654).networkView.RPC("pl", (RPCMode)6, new object[0]);
					}
		...
		internal FlameScriptt _0024self__00241655;

		public _0024Start_00241653(FlameScriptt self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241655);
		}
	}
	...
	{
		return new _0024Start_00241653(this).GetEnumerator();
	}
