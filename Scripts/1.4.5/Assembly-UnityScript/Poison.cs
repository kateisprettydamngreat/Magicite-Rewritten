...
public class Poison : MonoBehaviour
{
	...
	internal sealed class _0024Start_00242517 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal Poison _0024self__00242518;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					if (Network.isServer)
					{
						Network.RemoveRPCs(_0024self__00242518.parent.networkView.viewID);
						Network.Destroy(_0024self__00242518.parent.networkView.viewID);
					}
					goto IL_00a4;
				case 3:
					Object.Destroy((Object)(object)_0024self__00242518.parent.gameObject);
					goto IL_00a4;
				case 1:
					{
						result = 0;
		...
		internal Poison _0024self__00242519;

		public _0024Start_00242517(Poison self_)
		{
