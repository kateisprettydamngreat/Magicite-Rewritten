...
public class BallScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Die_00241342 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal BallScript _0024self__00241343;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					Network.RemoveRPCs(((Component)_0024self__00241343).networkView.viewID);
					Network.Destroy(((Component)_0024self__00241343).networkView.viewID);
					goto IL_008b;
				case 3:
		...
		public _0024Die_00241342(BallScript self_)
		{
	...
	{
		return new _0024Die_00241342(this).GetEnumerator();
	}
