...
public class CoinScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241449 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal CoinScript _0024self__00241450;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					_0024self__00241450.core.animation.Play();
					_0024self__00241450.@base.collider.enabled = true;
					_0024self__00241450.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(10f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00241450).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241450).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241450).gameObject);
					}
		...
		internal CoinScript _0024self__00241451;

		public _0024Start_00241449(CoinScript self_)
		{
