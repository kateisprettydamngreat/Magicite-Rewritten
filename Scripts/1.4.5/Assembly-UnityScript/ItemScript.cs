...
public class ItemScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242034 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024704_00242035;

			internal Vector3 _0024_0024705_00242036;

			internal ItemScript _0024self__00242037;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242037.dropped)
					{
						_0024self__00242037.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024704_00242035 = Random.Range(5, 9));
						Vector3 val = (_0024_0024705_00242036 = _0024self__00242037.r.velocity);
						float num2 = (_0024_0024705_00242036.y = _0024_0024704_00242035);
						Vector3 val3 = (_0024self__00242037.r.velocity = _0024_0024705_00242036);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00242037.@base.collider.enabled = true;
					_0024self__00242037.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(30f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00242037).networkView.viewID);
						Network.Destroy(((Component)_0024self__00242037).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242037).gameObject);
					}
		...
		internal ItemScript _0024self__00242038;

		public _0024Start_00242034(ItemScript self_)
		{
	...
	{
		return new _0024Start_00242034(this).GetEnumerator();
	}
