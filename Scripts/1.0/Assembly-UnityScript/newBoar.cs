...
public class newBoar : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeRight_00243082 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_00241169_00243083;

			internal Vector3 _0024_00241170_00243084;

			internal newBoar _0024self__00243085;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00243085.charging && MenuScript.multiplayer == 1 && !_0024self__00243085.gooing)
					{
						int num = (_0024_00241169_00243083 = 8);
						Vector3 val = (_0024_00241170_00243084 = _0024self__00243085.r.velocity);
						float num2 = (_0024_00241170_00243084.y = _0024_00241169_00243083);
						Vector3 val3 = (_0024self__00243085.r.velocity = _0024_00241170_00243084);
						_0024self__00243085.spdd = 0;
						_0024self__00243085.gooing = true;
					...
					goto IL_01ac;
				case 2:
					((Component)_0024self__00243085).networkView.RPC("RUN", (RPCMode)2, new object[0]);
					_0024self__00243085.charging = true;
					_0024self__00243085.spdd = 15;
				...
				case 3:
					...
					break;
				case 4:
					_0024self__00243085.gooing = false;
					goto IL_01ac;
				case 1:
					{
						result = 0;
		...
		internal newBoar _0024self__00243086;

		public _0024ChargeRight_00243082(newBoar self_)
		{
	...
	internal sealed class _0024ChargeLeft_00243087 : GenericGenerator<WaitForSeconds>
	{
		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_00241171_00243088;

			internal Vector3 _0024_00241172_00243089;

			internal newBoar _0024self__00243090;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00243090.charging && MenuScript.multiplayer == 1 && !_0024self__00243090.gooing)
					{
						int num = (_0024_00241171_00243088 = 8);
						Vector3 val = (_0024_00241172_00243089 = _0024self__00243090.r.velocity);
						float num2 = (_0024_00241172_00243089.y = _0024_00241171_00243088);
						Vector3 val3 = (_0024self__00243090.r.velocity = _0024_00241172_00243089);
						_0024self__00243090.spdd = 0;
						_0024self__00243090.gooing = true;
						((Component)_0024self__00243090).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
						((Component)_0024self__00243090).networkView.RPC("ATK", (RPCMode)2, new object[0]);
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
						break;
					}
					goto IL_01ac;
				case 2:
					((Component)_0024self__00243090).networkView.RPC("RUN", (RPCMode)2, new object[0]);
					_0024self__00243090.charging = true;
					_0024self__00243090.spdd = -15;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(1.2f)) ? 1 : 0);
					break;
				case 3:
					...
					break;
				case 4:
					_0024self__00243090.gooing = false;
					goto IL_01ac;
				case 1:
					{
						result = 0;
		...
		internal newBoar _0024self__00243091;

		public _0024ChargeLeft_00243087(newBoar self_)
		{
	...
	{
		return new _0024ChargeRight_00243082(this).GetEnumerator();
	}
