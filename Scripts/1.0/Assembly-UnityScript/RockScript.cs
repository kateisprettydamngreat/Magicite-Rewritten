...
public class RockScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Die_00242473 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal RockScript _0024self__00242474;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						Network.Destroy(((Component)_0024self__00242474).networkView.viewID);
					}
		...
		internal RockScript _0024self__00242475;

		public _0024Die_00242473(RockScript self_)
		{
	...
	{
		return new _0024Die_00242473(this).GetEnumerator();
	}
