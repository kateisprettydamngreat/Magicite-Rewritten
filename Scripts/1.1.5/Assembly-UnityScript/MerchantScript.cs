...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241217 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			internal MerchantScript _0024self__00241218;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241218).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241218.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241218).StartCoroutine_Auto(_0024self__00241218.Talkn(_0024self__00241218.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		internal MerchantScript _0024self__00241219;

		public _0024Start_00241217(MerchantScript self_)
		{
		...
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241219);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241220 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241221;

			internal MerchantScript _0024self__00241222;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241222.@base.animation.Play("t");
					_0024self__00241222.txtTalk.text = _0024s_00241221;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241222.txtTalk.text = string.Empty;
					_0024self__00241222.@base.animation.Play("i");
		...
		internal string _0024s_00241223;

		internal MerchantScript _0024self__00241224;

		public _0024Talkn_00241220(string s, MerchantScript self_)
		{
			_0024s_00241223 = s;
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241223, _0024self__00241224);
		}
	}
	...
	{
		return new _0024Talkn_00241220(s, this).GetEnumerator();
	}
