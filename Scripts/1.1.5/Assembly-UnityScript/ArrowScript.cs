...
public class ArrowScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241306 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal ArrowScript _0024self__00241307;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241307.t = ((Component)_0024self__00241307).transform;
					if (_0024self__00241307.isEnemy)
					{
						_0024self__00241307.speed = 23f;
					}
					if (_0024self__00241307.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241307).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241307).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241307).gameObject);
					}
		...
		internal ArrowScript _0024self__00241308;

		public _0024Start_00241306(ArrowScript self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241308);
		}
	}
	...
	public override void OnTriggerEnter(Collider c)
	{
		...
		else if (((Component)c).gameObject.layer == 11 && !initialized && !isEnemy && MenuScript.multiplayer == 1)
		{
			initialized = true;
			cantMove = true;
