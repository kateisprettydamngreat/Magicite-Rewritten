...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242560 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242561;

			internal ScourgeWall _0024self__00242562;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242562).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242561 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242562.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242563;

		public _0024ShootStuff_00242560(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242564 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242565;

			internal ScourgeWall _0024self__00242566;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242565 = dmg;
				_0024self__00242566 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242566.hp -= _0024dmg_00242565;
		...
		internal int _0024dmg_00242567;

		internal ScourgeWall _0024self__00242568;

		public _0024TDN_00242564(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242567 = dmg;
			_0024self__00242568 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242567, _0024self__00242568);
		}
	}
	...
	{
		return new _0024ShootStuff_00242560(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242564(dmg, this).GetEnumerator();
	}
