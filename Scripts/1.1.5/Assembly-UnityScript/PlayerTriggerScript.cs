...
public class PlayerTriggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TD_00242459 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024finalDMG_00242460;

			internal int _0024poo_00242461;

			internal Item _0024item_00242462;

			internal GameObject _0024d_00242463;

			internal int _0024se_00242464;

			internal GameObject _0024n2_00242465;

			internal int _0024DMG_00242466;

			internal PlayerTriggerScript _0024self__00242467;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024finalDMG_00242460 = _0024DMG_00242466 - ShieldDEF;
					if (_0024finalDMG_00242460 < 1)
					{
						_0024finalDMG_00242460 = 1;
					}
					if (MenuScript.multiplayer > 0 && ((Component)_0024self__00242467).networkView.isMine && canTakeDamage && !GameScript.win)
					{
						GameScript.hitsTaken++;
						if (MenuScript.pHat == 24)
						{
							_0024finalDMG_00242460 = (int)((float)_0024finalDMG_00242460 * 0.5f);
						}
						if (MenuScript.pHat == 13)
						{
							_0024poo_00242461 = Random.Range(0, 5);
							if (_0024poo_00242461 == 0)
							{
								_0024item_00242462 = new Item(Random.Range(9, 12), 1, new int[4], 0f, null);
								_0024d_00242463 = (GameObject)Network.Instantiate(Resources.Load("item"), ((Component)_0024self__00242467).transform.position, Quaternion.identity, 1);
								_0024d_00242463.networkView.RPC("SetID", (RPCMode)6, new object[1] { _0024item_00242462.id });
								_0024d_00242463.networkView.RPC("SetD", (RPCMode)6, new object[1] { _0024item_00242462.d });
								_0024d_00242463.networkView.RPC("SetE", (RPCMode)6, new object[1] { _0024item_00242462.e });
								_0024d_00242463.networkView.RPC("SetQ", (RPCMode)6, new object[1] { _0024item_00242462.q });
							}
						}
						else if (MenuScript.pHat == 14)
						{
							_0024se_00242464 = Random.Range(0, 10);
							if (_0024se_00242464 == 0)
							{
								Network.Instantiate(Resources.Load("e/broodmother"), new Vector3(((Component)_0024self__00242467).transform.position.x, ((Component)_0024self__00242467).transform.position.y + 50f, 0f), Quaternion.identity, 0);
							}
						}
						((Component)_0024self__00242467).audio.PlayOneShot(_0024self__00242467.ow);
						canTakeDamage = false;
						_0024n2_00242465 = (GameObject)Network.Instantiate((Object)(GameObject)Resources.Load("TD1", typeof(GameObject)), ((Component)_0024self__00242467).transform.position, Quaternion.identity, 0);
						_0024n2_00242465.networkView.RPC("SDN", (RPCMode)2, new object[1] { _0024finalDMG_00242460 });
						_0024self__00242467.gameScript.TD(_0024finalDMG_00242460);
						_0024self__00242467.gameScript.LoadHearts();
						GameScript.canTakeDamage = false;
						((MonoBehaviour)_0024self__00242467).StartCoroutine_Auto(_0024self__00242467.GetHit());
						if (GameScript.HP >= 1)
						{
						...
						GameScript.HP = 0;
						_0024self__00242467.player.SendMessage("Die");
						if (MenuScript.deathA == 1)
						{
							_0024self__00242467.player.SendMessage("DeathAnim");
						}
						isDead = true;
						_0024self__00242467.@base.animation.Play("dead");
					}
					goto IL_0392;
				case 2:
					canTakeDamage = true;
		...
		internal int _0024DMG_00242468;

		internal PlayerTriggerScript _0024self__00242469;

		public _0024TD_00242459(int DMG, PlayerTriggerScript self_)
		{
			_0024DMG_00242468 = DMG;
			_0024self__00242469 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024DMG_00242468, _0024self__00242469);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GetHit_00242470 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024910_00242471;

			internal Vector3 _0024_0024911_00242472;

			internal int _0024_0024912_00242473;

			internal Vector3 _0024_0024913_00242474;

			internal PlayerTriggerScript _0024self__00242475;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					((Component)_0024self__00242475).animation.Play();
					_0024self__00242475.gameScript.heartsObj.animation.Play();
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
					break;
				case 2:
				{
					((Component)_0024self__00242475).animation.Stop();
					_0024self__00242475.gameScript.heartsObj.animation.Stop();
					GameScript.canTakeDamage = true;
					int num = (_0024_0024910_00242471 = 0);
					Vector3 val = (_0024_0024911_00242472 = ((Component)_0024self__00242475).transform.localPosition);
					float num2 = (_0024_0024911_00242472.z = _0024_0024910_00242471);
					Vector3 val3 = (((Component)_0024self__00242475).transform.localPosition = _0024_0024911_00242472);
					int num3 = (_0024_0024912_00242473 = 20);
					Vector3 val4 = (_0024_0024913_00242474 = _0024self__00242475.gameScript.heartsObj.transform.localPosition);
					float num4 = (_0024_0024913_00242474.z = _0024_0024912_00242473);
					Vector3 val6 = (_0024self__00242475.gameScript.heartsObj.transform.localPosition = _0024_0024913_00242474);
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				}
				case 1:
		...
		internal PlayerTriggerScript _0024self__00242476;

		public _0024GetHit_00242470(PlayerTriggerScript self_)
		{
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00242476);
		}
	}
	...
	{
		return new _0024TD_00242459(DMG, this).GetEnumerator();
	}

	public override IEnumerator GetHit()
	{
		return new _0024GetHit_00242470(this).GetEnumerator();
	}
