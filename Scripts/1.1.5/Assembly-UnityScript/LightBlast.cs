...
public class LightBlast : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242044 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal LightBlast _0024self__00242045;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242045.t = ((Component)_0024self__00242045).transform;
					if (_0024self__00242045.isRight)
					{
					}
					((Component)_0024self__00242045).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00242045).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242045).gameObject);
					}
		...
		internal LightBlast _0024self__00242046;

		public _0024Start_00242044(LightBlast self_)
		{
	...
	{
		return new _0024Start_00242044(this).GetEnumerator();
	}
