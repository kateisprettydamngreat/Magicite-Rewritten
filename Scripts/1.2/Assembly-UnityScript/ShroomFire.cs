...
public class ShroomFire : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242665 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						Network.Destroy(((Component)_0024self__00242666).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242666).gameObject);
					}
		...
		internal ShroomFire _0024self__00242667;

		public _0024Start_00242665(ShroomFire self_)
		{
	...
	{
		return new _0024Start_00242665(this).GetEnumerator();
	}
