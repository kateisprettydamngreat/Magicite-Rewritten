...
public class OreSpider : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeRight_00242245 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024767_00242246;

			internal Vector3 _0024_0024768_00242247;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					{
						int num = (_0024_0024767_00242246 = 12);
						Vector3 val = (_0024_0024768_00242247 = _0024self__00242248.r.velocity);
						float num2 = (_0024_0024768_00242247.y = _0024_0024767_00242246);
						Vector3 val3 = (_0024self__00242248.r.velocity = _0024_0024768_00242247);
						_0024self__00242248.charging = true;
						((Component)_0024self__00242248).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
						((Component)_0024self__00242248).networkView.RPC("ATK", (RPCMode)2, new object[0]);
						_0024self__00242248.spdd = 5;
		...
		internal OreSpider _0024self__00242249;

		public _0024ChargeRight_00242245(OreSpider self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeLeft_00242250 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024769_00242251;

			internal Vector3 _0024_0024770_00242252;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					{
						int num = (_0024_0024769_00242251 = 12);
						Vector3 val = (_0024_0024770_00242252 = _0024self__00242253.r.velocity);
						float num2 = (_0024_0024770_00242252.y = _0024_0024769_00242251);
						Vector3 val3 = (_0024self__00242253.r.velocity = _0024_0024770_00242252);
						_0024self__00242253.charging = true;
						((Component)_0024self__00242253).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
		...
		public _0024ChargeLeft_00242250(OreSpider self_)
		{
	...
	{
		return new _0024ChargeRight_00242245(this).GetEnumerator();
	}

	public override IEnumerator ChargeLeft()
	{
		return new _0024ChargeLeft_00242250(this).GetEnumerator();
	}
