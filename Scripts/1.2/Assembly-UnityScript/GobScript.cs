...
public class GobScript : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeRight_00242674 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024981_00242675;

			internal Vector3 _0024_0024982_00242676;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242677.charging && MenuScript.multiplayer == 1)
					{
						int num = (_0024_0024981_00242675 = 15);
						Vector3 val = (_0024_0024982_00242676 = _0024self__00242677.r.velocity);
						float num2 = (_0024_0024982_00242676.y = _0024_0024981_00242675);
						Vector3 val3 = (_0024self__00242677.r.velocity = _0024_0024982_00242676);
						_0024self__00242677.charging = true;
						((Component)_0024self__00242677).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
						((Component)_0024self__00242677).networkView.RPC("ATK", (RPCMode)2, new object[0]);
						_0024self__00242677.spdd = 5;
				...
				case 2:
					...
					_0024self__00242677.charging = false;
					goto IL_011f;
				case 1:
					{
						result = 0;
		...
		internal GobScript _0024self__00242678;

		public _0024ChargeRight_00242674(GobScript self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChargeLeft_00242679 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024983_00242680;

			internal Vector3 _0024_0024984_00242681;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					{
						int num = (_0024_0024983_00242680 = 15);
						Vector3 val = (_0024_0024984_00242681 = _0024self__00242682.r.velocity);
						float num2 = (_0024_0024984_00242681.y = _0024_0024983_00242680);
						Vector3 val3 = (_0024self__00242682.r.velocity = _0024_0024984_00242681);
		...
		public _0024ChargeLeft_00242679(GobScript self_)
		{
	...
	{
		return new _0024ChargeRight_00242674(this).GetEnumerator();
	}

	public override IEnumerator ChargeLeft()
	{
		return new _0024ChargeLeft_00242679(this).GetEnumerator();
	}
