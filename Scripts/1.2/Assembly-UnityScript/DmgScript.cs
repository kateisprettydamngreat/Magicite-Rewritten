...
public class DmgScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241477 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024521_00241478;

			internal Vector3 _0024_0024522_00241479;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241480.t = ((Component)_0024self__00241480).transform;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.15f)) ? 1 : 0);
					break;
				case 2:
				{
					_0024self__00241480.stop = true;
					int num = (_0024_0024521_00241478 = -10);
					Vector3 val = (_0024_0024522_00241479 = _0024self__00241480.t.position);
					float num2 = (_0024_0024522_00241479.z = _0024_0024521_00241478);
					Vector3 val3 = (_0024self__00241480.t.position = _0024_0024522_00241479);
					if (MenuScript.multiplayer > 0)
					{
						if (_0024self__00241480.type == 0)
						{
							result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(0.7f)) ? 1 : 0);
							break;
						}
						if (_0024self__00241480.type == 3)
						{
							Object.Destroy((Object)(object)((Component)_0024self__00241480).gameObject, 2f);
						}
						else
						{
							Object.Destroy((Object)(object)((Component)_0024self__00241480).gameObject, 1f);
						}
					}
					else
					{
				...
				case 3:
					...
					{
						Network.RemoveRPCs(((Component)_0024self__00241480).networkView.viewID);
						Network.Destroy(((Component)_0024self__00241480).networkView.viewID);
					}
					goto IL_0165;
				case 1:
					{
		...
		internal DmgScript _0024self__00241481;

		public _0024Start_00241477(DmgScript self_)
		{
	...
	{
		return new _0024Start_00241477(this).GetEnumerator();
	}
