...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242597 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal ScourgeWall _0024self__00242599;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242599).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242598 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242599.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242600;

		public _0024ShootStuff_00242597(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242601 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242602;

			internal ScourgeWall _0024self__00242603;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242602 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242603.hp -= _0024dmg_00242602;
		...
		internal int _0024dmg_00242604;

		internal ScourgeWall _0024self__00242605;

		public _0024TDN_00242601(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242604 = dmg;
			_0024self__00242605 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242604, _0024self__00242605);
		}
	}
	...
	{
		return new _0024ShootStuff_00242597(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242601(dmg, this).GetEnumerator();
	}
