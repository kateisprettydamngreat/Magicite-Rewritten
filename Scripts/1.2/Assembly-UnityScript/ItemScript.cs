...
public class ItemScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242031 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024705_00242032;

			internal Vector3 _0024_0024706_00242033;

			internal ItemScript _0024self__00242034;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242034.dropped)
					{
						_0024self__00242034.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024705_00242032 = Random.Range(5, 9));
						Vector3 val = (_0024_0024706_00242033 = _0024self__00242034.r.velocity);
						float num2 = (_0024_0024706_00242033.y = _0024_0024705_00242032);
						Vector3 val3 = (_0024self__00242034.r.velocity = _0024_0024706_00242033);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00242034.@base.collider.enabled = true;
					_0024self__00242034.can = true;
		...
		internal ItemScript _0024self__00242035;

		public _0024Start_00242031(ItemScript self_)
		{
	...
	{
		return new _0024Start_00242031(this).GetEnumerator();
	}
