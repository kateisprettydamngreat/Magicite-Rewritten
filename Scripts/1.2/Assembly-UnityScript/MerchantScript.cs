...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241238 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241239).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241239.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241239).StartCoroutine_Auto(_0024self__00241239.Talkn(_0024self__00241239.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		internal MerchantScript _0024self__00241240;

		public _0024Start_00241238(MerchantScript self_)
		{
		...
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241240);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241241 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241242;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241243.@base.animation.Play("t");
					_0024self__00241243.txtTalk.text = _0024s_00241242;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241243.txtTalk.text = string.Empty;
					_0024self__00241243.@base.animation.Play("i");
		...
		internal string _0024s_00241244;

		internal MerchantScript _0024self__00241245;

		public _0024Talkn_00241241(string s, MerchantScript self_)
		{
			_0024s_00241244 = s;
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241244, _0024self__00241245);
		}
	}
	...
	{
		return new _0024Start_00241238(this).GetEnumerator();
	}
	...
	{
		return new _0024Talkn_00241241(s, this).GetEnumerator();
	}
