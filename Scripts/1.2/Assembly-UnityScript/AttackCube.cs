...
public class AttackCube : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241330 : GenericGenerator<WaitForSeconds>
	{
		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!Object.op_Implicit((Object)(object)_0024self__00241331.gameScript))
					{
						_0024self__00241331.gameScript = (GameScript)(object)GameObject.Find("GameManager").GetComponent("GameScript");
					}
		...
		internal AttackCube _0024self__00241332;

		public _0024Start_00241330(AttackCube self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241332);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Anim_00241333 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00241334;

			internal int _0024_0024429_00241335;

			internal Vector2 _0024_0024430_00241336;

			internal float _0024_0024431_00241337;

			internal Vector2 _0024_0024432_00241338;

			internal int _0024_0024433_00241339;

			internal Vector2 _0024_0024434_00241340;
			...
			public override bool MoveNext()
			{
				...
				default:
				{
					_0024i_00241334 = default(int);
					int num = (_0024_0024429_00241335 = 0);
					Vector2 val = (_0024_0024430_00241336 = _0024self__00241341.atkAnim.renderer.material.mainTextureOffset);
					float num2 = (_0024_0024430_00241336.x = _0024_0024429_00241335);
					Vector2 val3 = (_0024self__00241341.atkAnim.renderer.material.mainTextureOffset = _0024_0024430_00241336);
					_0024i_00241334 = 0;
					goto IL_0154;
				}
				case 2:
				...
				case 1:
					...
					IL_0154:
					if (_0024i_00241334 < 3)
					{
						float num3 = (_0024_0024431_00241337 = _0024self__00241341.atkAnim.renderer.material.mainTextureOffset.x + 0.25f);
						Vector2 val4 = (_0024_0024432_00241338 = _0024self__00241341.atkAnim.renderer.material.mainTextureOffset);
						float num4 = (_0024_0024432_00241338.x = _0024_0024431_00241337);
						Vector2 val6 = (_0024self__00241341.atkAnim.renderer.material.mainTextureOffset = _0024_0024432_00241338);
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.05f)) ? 1 : 0);
						break;
					}
					num5 = (_0024_0024433_00241339 = 0);
					val7 = (_0024_0024434_00241340 = _0024self__00241341.atkAnim.renderer.material.mainTextureOffset);
					num6 = (_0024_0024434_00241340.x = _0024_0024433_00241339);
					val9 = (_0024self__00241341.atkAnim.renderer.material.mainTextureOffset = _0024_0024434_00241340);
		...
		internal AttackCube _0024self__00241342;

		public _0024Anim_00241333(AttackCube self_)
		{
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241342);
		}
	}
	...
	{
		return new _0024Anim_00241333(this).GetEnumerator();
	}
