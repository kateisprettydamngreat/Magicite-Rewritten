...
public class ArrowScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241327 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal ArrowScript _0024self__00241328;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241328.t = ((Component)_0024self__00241328).transform;
					if (_0024self__00241328.isEnemy)
					{
						_0024self__00241328.speed = 23f;
					}
					if (_0024self__00241328.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241328).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241328).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241328).gameObject);
					}
		...
		internal ArrowScript _0024self__00241329;

		public _0024Start_00241327(ArrowScript self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241329);
		}
	}
	...
	{
		return new _0024Start_00241327(this).GetEnumerator();
	}
	...
	public override void OnTriggerEnter(Collider c)
	{
		...
		else if (((Component)c).gameObject.layer == 8 && isEnemy)
		{
			((Component)c).gameObject.networkView.RPC("TD", (RPCMode)2, new object[1] { 3 });
			Network.Destroy(((Component)this).networkView.viewID);
			Network.RemoveRPCs(((Component)this).networkView.viewID);
		}
