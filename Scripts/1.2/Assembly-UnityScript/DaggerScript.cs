...
public class DaggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241471 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241472.t = ((Component)_0024self__00241472).transform;
					_0024self__00241472.rr = ((Component)_0024self__00241472).rigidbody;
					if (_0024self__00241472.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241472).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241472).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241472).gameObject);
					}
		...
		internal DaggerScript _0024self__00241473;

		public _0024Start_00241471(DaggerScript self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241473);
		}
	}
	...
	{
		return new _0024Start_00241471(this).GetEnumerator();
	}
