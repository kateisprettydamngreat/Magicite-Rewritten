...
public class DmgScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241476 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal int _0024_0024520_00241477;

			internal Vector3 _0024_0024521_00241478;
			...
			public override bool MoveNext()
			{
				...
				case 2:
				{
					...
					int num = (_0024_0024520_00241477 = -10);
					Vector3 val = (_0024_0024521_00241478 = _0024self__00241479.t.position);
					float num2 = (_0024_0024521_00241478.z = _0024_0024520_00241477);
					Vector3 val3 = (_0024self__00241479.t.position = _0024_0024521_00241478);
					if (MenuScript.multiplayer > 0)
					{
						...
						{
							Object.Destroy((Object)(object)((Component)_0024self__00241479).gameObject, 2f);
						}
						else
						{
							Object.Destroy((Object)(object)((Component)_0024self__00241479).gameObject, 1f);
						}
					}
					else
					{
