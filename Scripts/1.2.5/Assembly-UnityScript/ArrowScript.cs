...
public class ArrowScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241326 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal ArrowScript _0024self__00241327;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241327.t = ((Component)_0024self__00241327).transform;
					if (_0024self__00241327.isEnemy)
					{
						_0024self__00241327.speed = 23f;
					}
					if (_0024self__00241327.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241327).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241327).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241327).gameObject);
					}
		...
		public _0024Start_00241326(ArrowScript self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241328);
		}
	}
	...
	{
		return new _0024Start_00241326(this).GetEnumerator();
	}
