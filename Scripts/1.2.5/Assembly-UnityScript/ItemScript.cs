...
public class ItemScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242030 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024704_00242031;

			internal Vector3 _0024_0024705_00242032;

			internal ItemScript _0024self__00242033;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00242033.dropped)
					{
						_0024self__00242033.r.AddForce(new Vector3((float)Random.Range(-1, 2), 1f, 0f) * 200f);
						int num = (_0024_0024704_00242031 = Random.Range(5, 9));
						Vector3 val = (_0024_0024705_00242032 = _0024self__00242033.r.velocity);
						float num2 = (_0024_0024705_00242032.y = _0024_0024704_00242031);
						Vector3 val3 = (_0024self__00242033.r.velocity = _0024_0024705_00242032);
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00242033.@base.collider.enabled = true;
					_0024self__00242033.can = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(30f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.RemoveRPCs(((Component)_0024self__00242033).networkView.viewID);
						Network.Destroy(((Component)_0024self__00242033).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242033).gameObject);
					}
		...
		public _0024Start_00242030(ItemScript self_)
		{
