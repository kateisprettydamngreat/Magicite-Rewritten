...
public class LightBlast : MonoBehaviour
{
	...
	internal sealed class _0024Start_00242080 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal LightBlast _0024self__00242081;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242081.t = ((Component)_0024self__00242081).transform;
					if (_0024self__00242081.isRight)
					{
					}
					((Component)_0024self__00242081).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00242081).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242081).gameObject);
					}
		...
		internal LightBlast _0024self__00242082;

		public _0024Start_00242080(LightBlast self_)
		{
