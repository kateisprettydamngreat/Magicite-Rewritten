...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242596 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242597;

			internal ScourgeWall _0024self__00242598;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242598).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242597 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242598.headPoint.transform.position, Quaternion.identity, 0);
		...
		public _0024ShootStuff_00242596(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242600 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242601;

			internal ScourgeWall _0024self__00242602;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242601 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242602.hp -= _0024dmg_00242601;
		...
		internal int _0024dmg_00242603;

		internal ScourgeWall _0024self__00242604;

		public _0024TDN_00242600(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242603 = dmg;
			_0024self__00242604 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242603, _0024self__00242604);
		}
	}
	...
	{
		return new _0024ShootStuff_00242596(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242600(dmg, this).GetEnumerator();
	}
