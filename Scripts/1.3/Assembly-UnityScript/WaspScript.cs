...
public class WaspScript : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GoCrazy_00242923 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024x_00242924;

			internal int _0024y_00242925;

			internal int _0024i_00242926;

			internal WaspScript _0024self__00242927;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024x_00242924 = Random.Range(-5, 5);
					_0024y_00242925 = Random.Range(-5, 5);
					_0024i_00242926 = default(int);
					_0024self__00242927.crazyVec = new Vector3((float)_0024x_00242924, (float)_0024y_00242925, 0f);
					_0024self__00242927.crazy = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(1f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00242927.crazy = false;
		...
		public _0024GoCrazy_00242923(WaspScript self_)
		{
	...
	internal sealed class _0024Attack_00242929 : GenericGenerator<WaitForSeconds>
	{
		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal WaspScript _0024self__00242930;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					if (Object.op_Implicit((Object)(object)_0024self__00242930.player) && MenuScript.multiplayer == 1)
					{
						_0024self__00242930.curVector = _0024self__00242930.player.transform.position - _0024self__00242930.t.position;
						if (!(_0024self__00242930.player.transform.position.x <= _0024self__00242930.t.position.x))
						{
							((Component)_0024self__00242930).networkView.RPC("TURN", (RPCMode)2, new object[1] { 1 });
						}
						else
						{
							((Component)_0024self__00242930).networkView.RPC("TURN", (RPCMode)2, new object[1] { 0 });
						}
						_0024self__00242930.atking = true;
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(1.2f)) ? 1 : 0);
						break;
					}
					goto case 3;
				case 3:
					_0024self__00242930.atking = false;
					((Component)_0024self__00242930).rigidbody.velocity = new Vector3(0f, 0f, 0f);
					goto default;
				case 1:
					result = 0;
					break;
		...
		internal WaspScript _0024self__00242931;

		public _0024Attack_00242929(WaspScript self_)
		{
	...
	{
		return new _0024GoCrazy_00242923(this).GetEnumerator();
	}
