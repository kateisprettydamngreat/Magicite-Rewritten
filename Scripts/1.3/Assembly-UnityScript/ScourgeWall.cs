...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242602 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242603;

			internal ScourgeWall _0024self__00242604;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242604).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242603 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242604.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242605;

		public _0024ShootStuff_00242602(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242606 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242607;

			internal ScourgeWall _0024self__00242608;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242607 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242608.hp -= _0024dmg_00242607;
		...
		internal int _0024dmg_00242609;

		internal ScourgeWall _0024self__00242610;

		public _0024TDN_00242606(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242609 = dmg;
			_0024self__00242610 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242609, _0024self__00242610);
		}
	}
	...
	{
		return new _0024ShootStuff_00242602(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242606(dmg, this).GetEnumerator();
	}
