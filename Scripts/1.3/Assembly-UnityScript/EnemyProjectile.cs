...
public class EnemyProjectile : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241488 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal EnemyProjectile _0024self__00241489;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241489.t = ((Component)_0024self__00241489).transform;
					...
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241489).gameObject, 5f);
					}
					goto IL_0081;
				case 2:
					Network.Destroy(((Component)_0024self__00241489).networkView.viewID);
					goto IL_0081;
				case 1:
					{
						result = 0;
		...
		internal EnemyProjectile _0024self__00241490;

		public _0024Start_00241488(EnemyProjectile self_)
		{
