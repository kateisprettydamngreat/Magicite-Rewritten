...
public class ArrowScript : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241330 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal ArrowScript _0024self__00241331;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241331.t = ((Component)_0024self__00241331).transform;
					if (_0024self__00241331.isEnemy)
					{
						_0024self__00241331.speed = 23f;
					}
					if (_0024self__00241331.isRight)
					{
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.1f)) ? 1 : 0);
					break;
				case 2:
					((Component)_0024self__00241331).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 3:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00241331).gameObject);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00241331).gameObject);
					}
		...
		internal ArrowScript _0024self__00241332;

		public _0024Start_00241330(ArrowScript self_)
		{
