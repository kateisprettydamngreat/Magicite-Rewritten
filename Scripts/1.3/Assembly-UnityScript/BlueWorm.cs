...
public class BlueWorm : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Action_00241394 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			internal Vector3 _0024pos_00241396;

			internal BlueWorm _0024self__00241397;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					_0024pos_00241396 = default(Vector3);
					goto case 5;
				case 5:
				...
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						if (Network.isServer)
						{
							((Component)_0024self__00241397).networkView.RPC("A", (RPCMode)2, new object[0]);
						}
					}
					else
					{
						_0024self__00241397.@base.animation.Play("a");
					}
				...
				case 1:
					...
					IL_0182:
					if (_0024i_00241395 < 6)
					{
						_0024pos_00241396 = new Vector3(_0024self__00241397.t.position.x + (float)Random.Range(-8, 8), _0024self__00241397.t.position.y + 28f, 0f);
						if (MenuScript.multiplayer > 0)
						{
							Network.Instantiate(Resources.Load("rckW"), _0024pos_00241396, Quaternion.identity, 0);
						}
						else
						{
							Object.Instantiate(Resources.Load("rckW"), _0024pos_00241396, Quaternion.identity);
						}
		...
		internal BlueWorm _0024self__00241398;

		public _0024Action_00241394(BlueWorm self_)
		{
	...
	{
		return new _0024Action_00241394(this).GetEnumerator();
	}
}
