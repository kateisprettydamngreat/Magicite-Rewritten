...
public class PlayerTriggerScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TD_00242501 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024finalDMG_00242502;

			internal int _0024poo_00242503;

			internal Item _0024item_00242504;

			internal GameObject _0024d_00242505;

			internal int _0024se_00242506;

			internal GameObject _0024n2_00242507;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024finalDMG_00242502 = _0024DMG_00242508 - ShieldDEF;
					if (_0024finalDMG_00242502 < 1)
					{
						_0024finalDMG_00242502 = 1;
					}
					if (MenuScript.multiplayer > 0 && ((Component)_0024self__00242509).networkView.isMine && canTakeDamage && !GameScript.win)
					{
						GameScript.hitsTaken++;
						if (MenuScript.pHat == 24)
						{
							_0024finalDMG_00242502 = (int)((float)_0024finalDMG_00242502 * 0.5f);
						}
						if (MenuScript.pHat == 13)
						{
							_0024poo_00242503 = Random.Range(0, 5);
							if (_0024poo_00242503 == 0)
							{
								_0024item_00242504 = new Item(Random.Range(9, 12), 1, new int[4], 0f, null);
								_0024d_00242505 = (GameObject)Network.Instantiate(Resources.Load("item"), ((Component)_0024self__00242509).transform.position, Quaternion.identity, 1);
								_0024d_00242505.networkView.RPC("SetID", (RPCMode)6, new object[1] { _0024item_00242504.id });
								_0024d_00242505.networkView.RPC("SetD", (RPCMode)6, new object[1] { _0024item_00242504.d });
								_0024d_00242505.networkView.RPC("SetE", (RPCMode)6, new object[1] { _0024item_00242504.e });
								_0024d_00242505.networkView.RPC("SetQ", (RPCMode)6, new object[1] { _0024item_00242504.q });
							}
						}
						else if (MenuScript.pHat == 14)
						{
							_0024se_00242506 = Random.Range(0, 10);
							if (_0024se_00242506 == 0)
							{
								Network.Instantiate(Resources.Load("e/broodmother"), new Vector3(((Component)_0024self__00242509).transform.position.x, ((Component)_0024self__00242509).transform.position.y + 50f, 0f), Quaternion.identity, 0);
							}
						}
						((Component)_0024self__00242509).audio.PlayOneShot(_0024self__00242509.ow);
						canTakeDamage = false;
						_0024n2_00242507 = (GameObject)Network.Instantiate((Object)(GameObject)Resources.Load("TD1", typeof(GameObject)), ((Component)_0024self__00242509).transform.position, Quaternion.identity, 0);
						_0024n2_00242507.networkView.RPC("SDN", (RPCMode)2, new object[1] { _0024finalDMG_00242502 });
						_0024self__00242509.gameScript.TD(_0024finalDMG_00242502);
						_0024self__00242509.gameScript.LoadHearts();
						GameScript.canTakeDamage = false;
						((MonoBehaviour)_0024self__00242509).StartCoroutine_Auto(_0024self__00242509.GetHit());
						if (GameScript.HP >= 1)
						{
						...
						GameScript.HP = 0;
						_0024self__00242509.player.SendMessage("Die");
						if (MenuScript.deathA == 1)
						{
							_0024self__00242509.player.SendMessage("DeathAnim");
						}
						isDead = true;
						_0024self__00242509.@base.animation.Play("dead");
					}
					goto IL_0392;
				case 2:
					canTakeDamage = true;
		...
		internal int _0024DMG_00242510;

		internal PlayerTriggerScript _0024self__00242511;

		public _0024TD_00242501(int DMG, PlayerTriggerScript self_)
		{
			_0024DMG_00242510 = DMG;
			_0024self__00242511 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024DMG_00242510, _0024self__00242511);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024GetHit_00242512 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024914_00242513;

			internal Vector3 _0024_0024915_00242514;

			internal int _0024_0024916_00242515;

			internal Vector3 _0024_0024917_00242516;

			internal PlayerTriggerScript _0024self__00242517;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					((Component)_0024self__00242517).animation.Play();
					_0024self__00242517.gameScript.heartsObj.animation.Play();
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.7f)) ? 1 : 0);
					break;
				case 2:
				{
					((Component)_0024self__00242517).animation.Stop();
					_0024self__00242517.gameScript.heartsObj.animation.Stop();
					GameScript.canTakeDamage = true;
					int num = (_0024_0024914_00242513 = 0);
					Vector3 val = (_0024_0024915_00242514 = ((Component)_0024self__00242517).transform.localPosition);
					float num2 = (_0024_0024915_00242514.z = _0024_0024914_00242513);
					Vector3 val3 = (((Component)_0024self__00242517).transform.localPosition = _0024_0024915_00242514);
					int num3 = (_0024_0024916_00242515 = 20);
					Vector3 val4 = (_0024_0024917_00242516 = _0024self__00242517.gameScript.heartsObj.transform.localPosition);
					float num4 = (_0024_0024917_00242516.z = _0024_0024916_00242515);
					Vector3 val6 = (_0024self__00242517.gameScript.heartsObj.transform.localPosition = _0024_0024917_00242516);
					((GenericGeneratorEnumerator<WaitForSeconds>)this).YieldDefault(1);
					goto case 1;
				}
				case 1:
		...
		internal PlayerTriggerScript _0024self__00242518;

		public _0024GetHit_00242512(PlayerTriggerScript self_)
		{
	...
	{
		return new _0024TD_00242501(DMG, this).GetEnumerator();
	}

	public override IEnumerator GetHit()
	{
		return new _0024GetHit_00242512(this).GetEnumerator();
	}
