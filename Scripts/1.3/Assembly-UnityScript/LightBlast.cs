...
public class LightBlast : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00242086 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal LightBlast _0024self__00242087;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242087.t = ((Component)_0024self__00242087).transform;
					if (_0024self__00242087.isRight)
					{
					}
					((Component)_0024self__00242087).collider.enabled = true;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						Network.Destroy(((Component)_0024self__00242087).networkView.viewID);
					}
					else
					{
						Object.Destroy((Object)(object)((Component)_0024self__00242087).gameObject);
					}
		...
		internal LightBlast _0024self__00242088;

		public _0024Start_00242086(LightBlast self_)
		{
	...
	{
		return new _0024Start_00242086(this).GetEnumerator();
	}
