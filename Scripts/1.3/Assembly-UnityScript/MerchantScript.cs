...
public class MerchantScript : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_00241241 : GenericGenerator<YieldInstruction>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<YieldInstruction>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 4;
				case 2:
					((Component)_0024self__00241242).networkView.RPC("Talkn", (RPCMode)2, new object[1] { _0024self__00241242.GetRandomText() });
					goto IL_0039;
				case 4:
					...
					break;
				case 3:
					result = (((GenericGeneratorEnumerator<YieldInstruction>)this).Yield(4, (YieldInstruction)(object)((MonoBehaviour)_0024self__00241242).StartCoroutine_Auto(_0024self__00241242.Talkn(_0024self__00241242.GetRandomText()))) ? 1 : 0);
					break;
				case 1:
					{
						result = 0;
		...
		internal MerchantScript _0024self__00241243;

		public _0024Start_00241241(MerchantScript self_)
		{
		...
		{
			return (IEnumerator<YieldInstruction>)(object)new _0024(_0024self__00241243);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Talkn_00241244 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal string _0024s_00241245;

			internal MerchantScript _0024self__00241246;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00241246.@base.animation.Play("t");
					_0024self__00241246.txtTalk.text = _0024s_00241245;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(2f)) ? 1 : 0);
					break;
				case 2:
					_0024self__00241246.txtTalk.text = string.Empty;
					_0024self__00241246.@base.animation.Play("i");
		...
		internal string _0024s_00241247;

		internal MerchantScript _0024self__00241248;

		public _0024Talkn_00241244(string s, MerchantScript self_)
		{
			_0024s_00241247 = s;
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024s_00241247, _0024self__00241248);
		}
	}
	...
	{
		return new _0024Start_00241241(this).GetEnumerator();
	}
	...
	{
		return new _0024Talkn_00241244(s, this).GetEnumerator();
	}
