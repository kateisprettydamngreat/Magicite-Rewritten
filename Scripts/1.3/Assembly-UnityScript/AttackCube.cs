...
public class AttackCube : MonoBehaviour
{
	...
	internal sealed class _0024Start_00241333 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal AttackCube _0024self__00241334;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!Object.op_Implicit((Object)(object)_0024self__00241334.gameScript))
					{
						_0024self__00241334.gameScript = (GameScript)(object)GameObject.Find("GameManager").GetComponent("GameScript");
					}
		...
		internal AttackCube _0024self__00241335;

		public _0024Start_00241333(AttackCube self_)
		{
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241335);
		}
	}

	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Anim_00241336 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00241337;

			internal int _0024_0024432_00241338;

			internal Vector2 _0024_0024433_00241339;

			internal float _0024_0024434_00241340;

			internal Vector2 _0024_0024435_00241341;

			internal int _0024_0024436_00241342;

			internal Vector2 _0024_0024437_00241343;

			internal AttackCube _0024self__00241344;
			...
			public override bool MoveNext()
			{
				...
				default:
				{
					_0024i_00241337 = default(int);
					int num = (_0024_0024432_00241338 = 0);
					Vector2 val = (_0024_0024433_00241339 = _0024self__00241344.atkAnim.renderer.material.mainTextureOffset);
					float num2 = (_0024_0024433_00241339.x = _0024_0024432_00241338);
					Vector2 val3 = (_0024self__00241344.atkAnim.renderer.material.mainTextureOffset = _0024_0024433_00241339);
					_0024i_00241337 = 0;
					goto IL_0154;
				}
				case 2:
				...
				case 1:
					...
					IL_0154:
					if (_0024i_00241337 < 3)
					{
						float num3 = (_0024_0024434_00241340 = _0024self__00241344.atkAnim.renderer.material.mainTextureOffset.x + 0.25f);
						Vector2 val4 = (_0024_0024435_00241341 = _0024self__00241344.atkAnim.renderer.material.mainTextureOffset);
						float num4 = (_0024_0024435_00241341.x = _0024_0024434_00241340);
						Vector2 val6 = (_0024self__00241344.atkAnim.renderer.material.mainTextureOffset = _0024_0024435_00241341);
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.05f)) ? 1 : 0);
						break;
					}
					num5 = (_0024_0024436_00241342 = 0);
					val7 = (_0024_0024437_00241343 = _0024self__00241344.atkAnim.renderer.material.mainTextureOffset);
					num6 = (_0024_0024437_00241343.x = _0024_0024436_00241342);
					val9 = (_0024self__00241344.atkAnim.renderer.material.mainTextureOffset = _0024_0024437_00241343);
		...
		internal AttackCube _0024self__00241345;

		public _0024Anim_00241336(AttackCube self_)
		{
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024self__00241345);
		}
	}
	...
	{
		return new _0024Anim_00241336(this).GetEnumerator();
	}
