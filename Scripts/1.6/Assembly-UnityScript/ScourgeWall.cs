...
public class ScourgeWall : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ShootStuff_00242640 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024i_00242641;

			internal ScourgeWall _0024self__00242642;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					goto case 1;
				case 2:
					((Component)_0024self__00242642).networkView.RPC("SHOOT", (RPCMode)2, new object[0]);
				...
				case 1:
					...
					IL_00e1:
					if (_0024i_00242641 < 5)
					{
						Network.Instantiate(Resources.Load("ballR"), _0024self__00242642.headPoint.transform.position, Quaternion.identity, 0);
		...
		internal ScourgeWall _0024self__00242643;

		public _0024ShootStuff_00242640(ScourgeWall self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024TDN_00242644 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024dmg_00242645;

			internal ScourgeWall _0024self__00242646;

			public _0024(int dmg, ScourgeWall self_)
			{
				_0024dmg_00242645 = dmg;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					_0024self__00242646.hp -= _0024dmg_00242645;
		...
		internal int _0024dmg_00242647;

		internal ScourgeWall _0024self__00242648;

		public _0024TDN_00242644(int dmg, ScourgeWall self_)
		{
			_0024dmg_00242647 = dmg;
			_0024self__00242648 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dmg_00242647, _0024self__00242648);
		}
	}
	...
	{
		return new _0024ShootStuff_00242640(this).GetEnumerator();
	}
	...
	{
		return new _0024TDN_00242644(dmg, this).GetEnumerator();
	}
