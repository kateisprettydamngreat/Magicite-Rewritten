...
public class ShroomMage : EnemyScript
{
	...
	internal sealed class _0024Attack_00242711 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal GameObject _0024g_00242712;

			internal Vector3 _0024pp_00242713;

			internal ShroomMage _0024self__00242714;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					if (!(_0024pp_00242713.x <= ((Component)_0024self__00242714).transform.position.x))
					{
						...
						{
							_0024self__00242714.Turn(1);
						}
					}
					else if (MenuScript.multiplayer > 0)
					{
						((Component)_0024self__00242714).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
					}
					else
					{
						_0024self__00242714.Turn(0);
					}
					_0024g_00242712 = null;
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(0.3f)) ? 1 : 0);
					break;
				case 2:
					if (MenuScript.multiplayer > 0)
					{
						((Component)_0024self__00242714).networkView.RPC("A1", (RPCMode)2, new object[0]);
					}
					else
					{
						_0024self__00242714.@base.animation.Play("a1");
					}
					result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(3, new WaitForSeconds(0.4f)) ? 1 : 0);
					break;
				case 3:
					if (Object.op_Implicit((Object)(object)_0024self__00242714.player) && MenuScript.multiplayer == 1)
					{
						_0024g_00242712 = (GameObject)Network.Instantiate(Resources.Load("haz/shroomFire"), ((Component)_0024self__00242714).transform.position, Quaternion.identity, 0);
						_0024g_00242712.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024self__00242714.player.transform.position });
					}
		...
		internal ShroomMage _0024self__00242716;

		public _0024Attack_00242711(Vector3 pp, ShroomMage self_)
		{
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			//IL_0008: Unknown result type (might be due to invalid IL or missing references)
			_0024pp_00242715 = pp;
		...
		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			...
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024pp_00242715, _0024self__00242716);
		}
	}
	...
	public override IEnumerator Attack(Vector3 pp)
	{
		...
		return new _0024Attack_00242711(pp, this).GetEnumerator();
	}
