...
public class blackDragon : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Attack_00243107 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal GameObject _0024g_00243108;

			internal Vector3 _0024pp2_00243109;

			internal Vector3 _0024pp_00243110;

			internal blackDragon _0024self__00243111;
			...
			public override bool MoveNext()
			{
				...
				case 2:
					...
					{
						_0024self__00243111.@base.animation.Play("a");
					}
				...
				case 3:
					...
					{
						_0024pp2_00243109 = _0024self__00243111.player.transform.position;
						if (MenuScript.multiplayer > 0)
						{
							if (MenuScript.multiplayer == 1)
							{
								_0024g_00243108 = (GameObject)Network.Instantiate(Resources.Load("haz/whelpFire2"), ((Component)_0024self__00243111).transform.position, Quaternion.identity, 0);
								_0024g_00243108.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024pp2_00243109 });
								_0024pp2_00243109.y += 10f;
								_0024g_00243108 = (GameObject)Network.Instantiate(Resources.Load("haz/whelpFire2"), ((Component)_0024self__00243111).transform.position, Quaternion.identity, 0);
								_0024g_00243108.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024pp2_00243109 });
								_0024pp2_00243109.y -= 20f;
								_0024g_00243108 = (GameObject)Network.Instantiate(Resources.Load("haz/whelpFire2"), ((Component)_0024self__00243111).transform.position, Quaternion.identity, 0);
							}
							_0024g_00243108.networkView.RPC("Set", (RPCMode)2, new object[1] { _0024pp2_00243109 });
						}
					...
					if (Object.op_Implicit((Object)(object)_0024self__00243111.player))
					{
						_0024self__00243111.curVector = _0024self__00243111.t.position - _0024self__00243111.player.transform.position;
						if (!(_0024self__00243111.player.transform.position.x <= _0024self__00243111.t.position.x))
						{
							_0024self__00243111.e.transform.rotation = Quaternion.Euler(0f, 180f, 0f);
						}
						else
						{
							_0024self__00243111.e.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
						}
					}
					_0024self__00243111.atking = true;
				...
				case 4:
					...
					if (Object.op_Implicit((Object)(object)_0024self__00243111.player))
					{
						_0024self__00243111.curVector = _0024self__00243111.player.transform.position - _0024self__00243111.t.position;
						if (!(_0024self__00243111.player.transform.position.x <= _0024self__00243111.t.position.x))
						{
							_0024self__00243111.e.transform.rotation = Quaternion.Euler(0f, 180f, 0f);
						}
		...
		internal blackDragon _0024self__00243113;

		public _0024Attack_00243107(Vector3 pp, blackDragon self_)
		{
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			//IL_0008: Unknown result type (might be due to invalid IL or missing references)
			_0024pp_00243112 = pp;
	...
	public override IEnumerator Attack(Vector3 pp)
	{
		...
		return new _0024Attack_00243107(pp, this).GetEnumerator();
	}
