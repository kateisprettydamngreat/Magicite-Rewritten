...
public class InvaderScript : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Trigger_00242068 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal InvaderScript _0024self__00242069;
		...
		internal InvaderScript _0024self__00242070;

		public _0024Trigger_00242068(InvaderScript self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Attack_00242071 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal InvaderScript _0024self__00242072;
			...
			public override bool MoveNext()
			{
				...
				default:
					...
					break;
				case 2:
					if (Object.op_Implicit((Object)(object)_0024self__00242072.player))
					{
						_0024self__00242072.curVector = _0024self__00242072.player.transform.position - _0024self__00242072.t.position;
						if (!(_0024self__00242072.player.transform.position.x <= _0024self__00242072.t.position.x))
						{
					...
					goto case 3;
				case 3:
					_0024self__00242072.speed = Random.Range(12, 18);
		...
		internal InvaderScript _0024self__00242073;

		public _0024Attack_00242071(InvaderScript self_)
		{
	...
	{
		return new _0024Trigger_00242068(this).GetEnumerator();
	}
	...
	{
		return new _0024Attack_00242071(this).GetEnumerator();
	}
}
