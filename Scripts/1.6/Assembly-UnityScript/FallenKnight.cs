...
public class FallenKnight : EnemyScript
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024T_00241653 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024618_00241654;

			internal Quaternion _0024_0024619_00241655;

			internal int _0024_0024620_00241656;

			internal Quaternion _0024_0024621_00241657;

			internal FallenKnight _0024self__00241658;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241658.turning && !_0024self__00241658.ATKING)
					{
						_0024self__00241658.turning = true;
						if (_0024self__00241658.e.transform.rotation.y != 0f)
						{
							int num = (_0024_0024618_00241654 = 0);
							Quaternion val = (_0024_0024619_00241655 = _0024self__00241658.e.transform.rotation);
							float num2 = (_0024_0024619_00241655.y = _0024_0024618_00241654);
							Quaternion val3 = (_0024self__00241658.e.transform.rotation = _0024_0024619_00241655);
							if (MenuScript.multiplayer > 0)
							{
								((Component)_0024self__00241658).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
							}
						}
						else
						{
							int num3 = (_0024_0024620_00241656 = 180);
							Quaternion val4 = (_0024_0024621_00241657 = _0024self__00241658.e.transform.rotation);
							float num4 = (_0024_0024621_00241657.y = _0024_0024620_00241656);
							Quaternion val6 = (_0024self__00241658.e.transform.rotation = _0024_0024621_00241657);
							if (MenuScript.multiplayer > 0)
							{
								((Component)_0024self__00241658).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
							}
						}
						_0024self__00241658.spd *= -1;
						result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(1f)) ? 1 : 0);
						break;
					}
					goto IL_01cf;
				case 2:
					_0024self__00241658.turning = false;
					goto IL_01cf;
				case 1:
					{
						result = 0;
		...
		internal FallenKnight _0024self__00241659;

		public _0024T_00241653(FallenKnight self_)
		{
	...
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Attack_00241660 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024_0024622_00241661;

			internal Quaternion _0024_0024623_00241662;

			internal int _0024_0024624_00241663;

			internal Quaternion _0024_0024625_00241664;

			internal int _0024dir_00241665;

			internal FallenKnight _0024self__00241666;

			public _0024(int dir, FallenKnight self_)
			{
				_0024dir_00241665 = dir;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (!_0024self__00241666.ATKING)
					{
						_0024self__00241666.ATKING = true;
						if (_0024dir_00241665 == 0)
						{
							if (MenuScript.multiplayer > 0)
							{
								((Component)_0024self__00241666).networkView.RPC("Turn", (RPCMode)2, new object[1] { 0 });
								((Component)_0024self__00241666).networkView.RPC("Roar", (RPCMode)2, new object[0]);
								result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(2, new WaitForSeconds(1.2f)) ? 1 : 0);
							}
							else
							{
								int num = (_0024_0024622_00241661 = 0);
								Quaternion val = (_0024_0024623_00241662 = _0024self__00241666.e.transform.rotation);
								float num2 = (_0024_0024623_00241662.y = _0024_0024622_00241661);
								Quaternion val3 = (_0024self__00241666.e.transform.rotation = _0024_0024623_00241662);
						...
						{
							((Component)_0024self__00241666).networkView.RPC("Turn", (RPCMode)2, new object[1] { 1 });
							((Component)_0024self__00241666).networkView.RPC("Roar", (RPCMode)2, new object[0]);
							result = (((GenericGeneratorEnumerator<WaitForSeconds>)this).Yield(6, new WaitForSeconds(1.2f)) ? 1 : 0);
						}
						else
						{
							int num3 = (_0024_0024624_00241663 = 180);
							Quaternion val4 = (_0024_0024625_00241664 = _0024self__00241666.e.transform.rotation);
							float num4 = (_0024_0024625_00241664.y = _0024_0024624_00241663);
							Quaternion val6 = (_0024self__00241666.e.transform.rotation = _0024_0024625_00241664);
							_0024self__00241666.@base.animation.Play("a");
		...
		internal int _0024dir_00241667;

		internal FallenKnight _0024self__00241668;

		public _0024Attack_00241660(int dir, FallenKnight self_)
		{
			_0024dir_00241667 = dir;
			_0024self__00241668 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return (IEnumerator<WaitForSeconds>)(object)new _0024(_0024dir_00241667, _0024self__00241668);
		}
	}
	...
	{
		return new _0024T_00241653(this).GetEnumerator();
	}
	...
	{
		return new _0024Attack_00241660(dir, this).GetEnumerator();
	}
